...
(assert
  (not (exists ( (|$cond-alpha-rename:119| Int) (|$cond-alpha-rename:120| Int) )
    ( and (|main_1037$unknown:33| |$cond-alpha-rename:120| |$cond-alpha-rename:119|) (not (= 0 0)) (>= |$cond-alpha-rename:120| 0) (>= |$cond-alpha-rename:119| 0) )
    )
  )
)
(check-sat)
