...
(assert
  (not (exists ( (|$cond-alpha-rename:285| Int) )
    ( and (|main_1041$unknown:39| |$cond-alpha-rename:285|) (not (= 0 0)) (>= |$cond-alpha-rename:285| 0) (not (and (> (+ (+ 0 0) 0) (+ (+ 0 |$cond-alpha-rename:285|) 0)) (>= (+ (+ 0 |$cond-alpha-rename:285|) 0) 0))) )
    )
  )
)
(assert
