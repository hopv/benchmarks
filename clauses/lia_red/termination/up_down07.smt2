...
(assert
  (not (exists ( (|$cond-alpha-rename:1004| Int) (|$cond-alpha-rename:1005| Int) )
    ( and (|main_1037$unknown:45| |$cond-alpha-rename:1005| |$cond-alpha-rename:1004|) (not (= 0 0)) (> |$cond-alpha-rename:1004| 0) )
    )
  )
)
(assert
