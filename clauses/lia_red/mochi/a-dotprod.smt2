...
(assert
  (forall ( (|$cond-alpha-rename:18| Bool) (|$cond-alpha-rename:17| Bool) (|$knormal:21| Bool) (|$cond-alpha-rename:16| Bool) (|$knormal:32| Int) (|$alpha-10:n| Int) (|$cond-alpha-rename:19| Bool) (|$V-reftype:25| Int) (|$cond-alpha-rename:15| Int) (|$alpha-9:z| Int) )
    (=>
      ( and (= |$knormal:21| (= |$alpha-9:z| 0)) (= |$cond-alpha-rename:19| (and |$cond-alpha-rename:17| |$cond-alpha-rename:18|)) (= |$cond-alpha-rename:18| (< |$knormal:32| |$alpha-10:n|)) (= |$cond-alpha-rename:17| (<= 0 |$knormal:32|)) (= |$cond-alpha-rename:16| (= |$cond-alpha-rename:15| 0)) (= |$V-reftype:25| 0) |$knormal:21| |$cond-alpha-rename:19| |$cond-alpha-rename:16| (|dotprod$unknown:2| |$knormal:32| |$alpha-10:n|) )
      (|dotprod$unknown:3| |$V-reftype:25| |$knormal:32| |$alpha-10:n|)
    )
  )
)
(assert
  (forall ( (|$cond-alpha-rename:23| Bool) (|$cond-alpha-rename:22| Bool) (|$knormal:21| Bool) (|$cond-alpha-rename:21| Bool) (|$knormal:32| Int) (|$alpha-10:n| Int) (|$cond-alpha-rename:24| Bool) (|$V-reftype:25| Int) (|$cond-alpha-rename:20| Int) (|$alpha-9:z| Int) )
    (=>
      ( and (= |$knormal:21| (= |$alpha-9:z| 0)) (= |$cond-alpha-rename:24| (and |$cond-alpha-rename:22| |$cond-alpha-rename:23|)) (= |$cond-alpha-rename:23| (< |$knormal:32| |$alpha-10:n|)) (= |$cond-alpha-rename:22| (<= 0 |$knormal:32|)) (= |$cond-alpha-rename:21| (= |$cond-alpha-rename:20| 0)) (= |$V-reftype:25| 0) |$knormal:21| |$cond-alpha-rename:24| |$cond-alpha-rename:21| (|dotprod$unknown:4| |$knormal:32| |$alpha-10:n|) (|dotprod$unknown:2| |$knormal:32| |$alpha-10:n|) )
      (|dotprod$unknown:3| |$V-reftype:25| |$knormal:32| |$alpha-10:n|)
    )
  )
)
(assert
  (forall ( (|$cond-alpha-rename:28| Bool) (|$cond-alpha-rename:27| Bool) (|$knormal:21| Bool) (|$cond-alpha-rename:26| Bool) (|$knormal:31| Int) (|$alpha-10:n| Int) (|$cond-alpha-rename:29| Bool) (|$V-reftype:25| Int) (|$cond-alpha-rename:25| Int) (|$alpha-9:z| Int) )
    (=>
      ( and (= |$knormal:21| (= |$alpha-9:z| 0)) (= |$cond-alpha-rename:29| (and |$cond-alpha-rename:27| |$cond-alpha-rename:28|)) (= |$cond-alpha-rename:28| (< |$knormal:31| |$alpha-10:n|)) (= |$cond-alpha-rename:27| (<= 0 |$knormal:31|)) (= |$cond-alpha-rename:26| (= |$cond-alpha-rename:25| 0)) (= |$V-reftype:25| 0) |$knormal:21| |$cond-alpha-rename:29| |$cond-alpha-rename:26| (|dotprod$unknown:4| |$knormal:31| |$alpha-10:n|) (|dotprod$unknown:2| |$knormal:31| |$alpha-10:n|) )
      (|dotprod$unknown:5| |$V-reftype:25| |$knormal:31| |$alpha-10:n|)
    )
  )
)
(assert
  (forall ( (|$cond-alpha-rename:33| Bool) (|$cond-alpha-rename:32| Bool) (|$knormal:21| Bool) (|$cond-alpha-rename:31| Bool) (|$knormal:31| Int) (|$alpha-10:n| Int) (|$cond-alpha-rename:34| Bool) (|$V-reftype:25| Int) (|$cond-alpha-rename:30| Int) (|$alpha-9:z| Int) )
    (=>
      ( and (= |$knormal:21| (= |$alpha-9:z| 0)) (= |$cond-alpha-rename:34| (and |$cond-alpha-rename:32| |$cond-alpha-rename:33|)) (= |$cond-alpha-rename:33| (< |$knormal:31| |$alpha-10:n|)) (= |$cond-alpha-rename:32| (<= 0 |$knormal:31|)) (= |$cond-alpha-rename:31| (= |$cond-alpha-rename:30| 0)) (= |$V-reftype:25| 0) |$knormal:21| |$cond-alpha-rename:34| |$cond-alpha-rename:31| (|dotprod$unknown:4| |$knormal:31| |$alpha-10:n|) )
      (|dotprod$unknown:5| |$V-reftype:25| |$knormal:31| |$alpha-10:n|)
    )
  )
)
...
(assert
  (forall ( (|$alpha-10:n| Int) (|$alpha-9:z| Int) (|$cond-alpha-rename:2| Int) (|$cond-alpha-rename:1| Int) (|$knormal:21| Bool) )
    (=>
      ( and (= |$knormal:21| (= |$alpha-9:z| 0)) |$knormal:21| (= |$cond-alpha-rename:1| |$alpha-9:z|) (= |$cond-alpha-rename:2| |$alpha-9:z|) )
