...
(assert
  (forall ( (|$alpha-3:n| Int) (|$alpha-4:s| Int) (|$knormal:7| Int) (|$knormal:9| Int) )
    (=>
      ( and (|repeat$unknown:2| |$knormal:9| |$knormal:7|) (|repeat$unknown:5| |$knormal:7| |$alpha-4:s| (- |$alpha-3:n| 1)) (not (= |$alpha-3:n| 0)) )
      (|repeat$unknown:5| |$knormal:9| |$alpha-4:s| |$alpha-3:n|)
    )
  )
)
(assert
  (forall ( (|$alpha-3:n| Int) (|$alpha-4:s| Int) )
    (=>
      ( and (= |$alpha-3:n| 0) )
      (|repeat$unknown:5| |$alpha-4:s| |$alpha-4:s| |$alpha-3:n|)
    )
  )
)
(assert
  (not (exists ( (|$alpha-5:n| Int) (|$knormal:15| Int) )
    ( and (|repeat$unknown:5| |$knormal:15| 0 |$alpha-5:n|) (not (= |$knormal:15| |$alpha-5:n|)) )
    )
  )
)
(check-sat)
