...
(assert
  (forall ( (|$knormal:3| Bool) (|$alpha-2:x| Int) (|$knormal:11| Int) (|$knormal:12| Int) (|$alpha-3:y| Int) (|$knormal:4| Bool) (|$V-reftype:21| Int) )
    (=>
      ( and (= |$knormal:4| (= |$alpha-3:y| 0)) (= |$knormal:3| (= |$alpha-2:x| 0)) (= |$knormal:11| 1) (= |$V-reftype:21| |$knormal:12|) (not |$knormal:3|) |$knormal:4| (|zip$unknown:4| |$alpha-3:y| |$alpha-2:x|) true (|loop$unknown:2| |$knormal:12| |$knormal:11|) )
      (|zip$unknown:5| |$V-reftype:21| |$alpha-3:y| |$alpha-2:x|)
    )
  )
)
(assert
  (forall ( (|$knormal:13| Bool) (|$alpha-2:x| Int) (|$knormal:14| Int) (|$knormal:15| Int) (|$alpha-3:y| Int) (|$knormal:3| Bool) (|$V-reftype:18| Int) )
    (=>
      ( and (= |$knormal:3| (= |$alpha-2:x| 0)) (= |$knormal:14| 1) (= |$knormal:13| (= |$alpha-3:y| 0)) (= |$V-reftype:18| |$knormal:15|) (not |$knormal:13|) |$knormal:3| (|zip$unknown:4| |$alpha-3:y| |$alpha-2:x|) true (|loop$unknown:2| |$knormal:15| |$knormal:14|) )
...
(assert
  (forall ( (|$V-reftype:24| Int) (|$knormal:3| Bool) (|$knormal:7| Int) (|$alpha-2:x| Int) (|$alpha-3:y| Int) (|$knormal:9| Int) (|$knormal:5| Int) (|$knormal:4| Bool) )
    (=>
      ( and (= |$knormal:7| (- |$alpha-3:y| 1)) (= |$knormal:5| (- |$alpha-2:x| 1)) (= |$knormal:4| (= |$alpha-3:y| 0)) (= |$knormal:3| (= |$alpha-2:x| 0)) (= |$V-reftype:24| (+ 1 |$knormal:9|)) (not |$knormal:4|) (not |$knormal:3|) (|zip$unknown:5| |$knormal:9| |$knormal:7| |$knormal:5|) (|zip$unknown:4| |$alpha-3:y| |$alpha-2:x|) true )
...
(assert
  (forall ( (|$knormal:3| Bool) (|$alpha-2:x| Int) (|$alpha-3:y| Int) (|$knormal:13| Bool) (|$V-reftype:16| Int) )
    (=>
      ( and (= |$knormal:3| (= |$alpha-2:x| 0)) (= |$knormal:13| (= |$alpha-3:y| 0)) (= |$V-reftype:16| 0) |$knormal:3| |$knormal:13| (|zip$unknown:4| |$alpha-3:y| |$alpha-2:x|) true )
...
(assert
  (forall ( (|$knormal:13| Bool) (|$alpha-2:x| Int) (|$alpha-3:y| Int) (|$knormal:3| Bool) (|$knormal:14| Int) )
    (=>
      ( and (= |$knormal:3| (= |$alpha-2:x| 0)) (= |$knormal:14| 1) (= |$knormal:13| (= |$alpha-3:y| 0)) (not |$knormal:13|) |$knormal:3| (|zip$unknown:4| |$alpha-3:y| |$alpha-2:x|) true )
...
(assert
  (forall ( (|$knormal:3| Bool) (|$alpha-2:x| Int) (|$alpha-3:y| Int) (|$knormal:4| Bool) (|$knormal:11| Int) )
    (=>
      ( and (= |$knormal:4| (= |$alpha-3:y| 0)) (= |$knormal:3| (= |$alpha-2:x| 0)) (= |$knormal:11| 1) (not |$knormal:3|) |$knormal:4| (|zip$unknown:4| |$alpha-3:y| |$alpha-2:x|) true )
...
(assert
  (forall ( (|$knormal:4| Bool) (|$alpha-2:x| Int) (|$alpha-3:y| Int) (|$knormal:3| Bool) (|$knormal:5| Int) (|$knormal:7| Int) )
    (=>
      ( and (= |$knormal:7| (- |$alpha-3:y| 1)) (= |$knormal:5| (- |$alpha-2:x| 1)) (= |$knormal:4| (= |$alpha-3:y| 0)) (= |$knormal:3| (= |$alpha-2:x| 0)) (not |$knormal:4|) (not |$knormal:3|) (|zip$unknown:4| |$alpha-3:y| |$alpha-2:x|) true )
