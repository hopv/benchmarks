...
(assert
  (forall ( (|$alpha-9:n| Int) (|$knormal:32| Int) )
    (=>
      ( and (< |$knormal:32| |$alpha-9:n|) (<= 0 |$knormal:32|) (|dotprod$unknown:2| |$knormal:32| |$alpha-9:n|) )
...
(assert
  (forall ( (|$alpha-9:n| Int) (|$knormal:32| Int) )
    (=>
      ( and (< |$knormal:32| |$alpha-9:n|) (<= 0 |$knormal:32|) (|dotprod$unknown:4| |$knormal:32| |$alpha-9:n|) (|dotprod$unknown:2| |$knormal:32| |$alpha-9:n|) )
      (|dotprod$unknown:3| 0 |$knormal:32| |$alpha-9:n|)
    )
  )
)
(assert
  (forall ( (|$alpha-9:n| Int) (|$knormal:31| Int) )
    (=>
      ( and (< |$knormal:31| |$alpha-9:n|) (<= 0 |$knormal:31|) (|dotprod$unknown:4| |$knormal:31| |$alpha-9:n|) (|dotprod$unknown:2| |$knormal:31| |$alpha-9:n|) )
...
(assert
  (forall ( (|$alpha-9:n| Int) (|$knormal:31| Int) )
    (=>
      ( and (< |$knormal:31| |$alpha-9:n|) (<= 0 |$knormal:31|) (|dotprod$unknown:4| |$knormal:31| |$alpha-9:n|) )
      (|dotprod$unknown:5| 0 |$knormal:31| |$alpha-9:n|)
    )
  )
)
(assert
  (not (exists ( (|$alpha-1:n| Int) (|$alpha-2:i| Int) )
    ( and (not (and (<= 0 |$alpha-2:i|) (< |$alpha-2:i| |$alpha-1:n|))) (|dotprod$unknown:2| |$alpha-2:i| |$alpha-1:n|) )
    )
  )
)
(assert
  (not (exists ( (|$alpha-1:n| Int) (|$alpha-2:i| Int) )
    ( and (not (and (<= 0 |$alpha-2:i|) (< |$alpha-2:i| |$alpha-1:n|))) (|dotprod$unknown:4| |$alpha-2:i| |$alpha-1:n|) )
    )
  )
)
(assert
  (forall ( (|$alpha-9:n| Int) )
    (=>
      ( and true )
      (|dotprod$unknown:7| 0 0 |$alpha-9:n|)
    )
  )
)
(check-sat)
