...
(assert
  (forall ( (|$V-reftype:110| Int) (|$V-reftype:112| Int) (|$V-reftype:114| Int) (|$alpha-58:n_1039| Int) (|$alpha-66:f_1040| Int) (|$knormal:111| Int) (|$knormal:113| Int) )
    (=>
      ( and (|bot$unknown:2| |$knormal:111| 1) (|fail$unknown:33| |$knormal:113| 1) (|main_1041$unknown:39| |$alpha-58:n_1039|) (not (= 0 0)) (>= |$alpha-58:n_1039| 0) (>= |$alpha-58:n_1039| 0) (= (+ (* 0 |$alpha-58:n_1039|) 0) (+ (* 0 |$alpha-58:n_1039|) 0)) (= 0 0) (= 0 0) (= 0 0) )
...
(assert
  (not (exists ( (|$cond-alpha-rename:225| Int) )
    ( and (|main_1041$unknown:39| |$cond-alpha-rename:225|) (not (= 0 0)) (>= |$cond-alpha-rename:225| 0) )
    )
  )
)
(assert
