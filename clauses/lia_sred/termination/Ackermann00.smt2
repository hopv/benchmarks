...
(assert
  (not (exists ( (|$cond-alpha-rename:50| Int) (|$cond-alpha-rename:54| Int) )
    ( and (> |$cond-alpha-rename:54| 0) (> |$cond-alpha-rename:50| 0) (not (= 0 0)) (|main_1033$unknown:24| |$cond-alpha-rename:54| |$cond-alpha-rename:50|) )
    )
  )
)
(assert
