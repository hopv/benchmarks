...
(assert
  (forall ( (|$alpha-17:m_1031| Int) (|$alpha-21:n_1032| Int) (|$knormal:69| Int) (|$knormal:71| Int) (|$knormal:73| Int) )
    (=>
      ( and (|ack_without_checking_1087$unknown:18| |$knormal:69| |$alpha-21:n_1032| 0 0 0 |$alpha-17:m_1031| 0 0 0) (|bot$unknown:20| |$knormal:71| 1) (|fail$unknown:22| |$knormal:73| 1) (|main_1033$unknown:24| |$alpha-21:n_1032| |$alpha-17:m_1031|) (not (= 0 0)) (> |$alpha-17:m_1031| 0) (> |$alpha-21:n_1032| 0) )
...
(assert
  (forall ( (|$alpha-24:m_1035| Int) (|$alpha-25:n_1036| Int) (|$knormal:91| Int) )
    (=>
      ( and (|ack_1030$unknown:9| |$knormal:91| |$alpha-25:n_1036| 0 0 0 |$alpha-24:m_1035| 0 0 0) (|main_1033$unknown:24| |$alpha-25:n_1036| |$alpha-24:m_1035|) (> |$alpha-24:m_1035| 0) (> |$alpha-25:n_1036| 0) )
      (|main_1033$unknown:25| |$knormal:91| |$alpha-25:n_1036| |$alpha-24:m_1035|)
    )
  )
)
(assert
...
(assert
  (not (exists ( (|$cond-alpha-rename:34| Int) (|$cond-alpha-rename:38| Int) )
    ( and (|main_1033$unknown:24| |$cond-alpha-rename:38| |$cond-alpha-rename:34|) (not (= 0 0)) (> |$cond-alpha-rename:34| 0) (> |$cond-alpha-rename:38| 0) )
    )
  )
)
(assert
