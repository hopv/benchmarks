...
(assert
  (forall ( (|$alpha-18:xs_1031| Int) (|$alpha-22:ys_1032| Int) (|$knormal:34| Int) (|$knormal:36| Int) (|$knormal:38| Int) )
    (=>
      ( and (|append_without_checking_1072$unknown:18| |$knormal:34| |$alpha-22:ys_1032| 0 0 0 |$alpha-18:xs_1031| 0 0 0) (|bot$unknown:20| |$knormal:36| 1) (|fail$unknown:22| |$knormal:38| 1) (not (= 0 0)) )
