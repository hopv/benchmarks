...
(assert
  (forall ( (|$alpha-17:m_1031| Int) (|$alpha-21:n_1032| Int) (|$knormal:69| Int) (|$knormal:89| Int) )
    (=>
      ( and (|ack_without_checking_1087$unknown:18| |$knormal:69| |$alpha-21:n_1032| 0 0 0 |$alpha-17:m_1031| 0 0 0) (|fail$unknown:22| |$knormal:89| 1) (not (= 0 0)) (> |$alpha-17:m_1031| 0) (> |$alpha-21:n_1032| 0) (not (and (> (+ (+ 0 0) 0) (+ (+ 0 0) |$alpha-21:n_1032|)) (>= (+ (+ 0 0) |$alpha-21:n_1032|) 0))) )
...
(assert
  (forall ( (|$alpha-17:m_1031| Int) (|$alpha-21:n_1032| Int) (|$knormal:69| Int) )
    (=>
      ( and (|ack_without_checking_1087$unknown:18| |$knormal:69| |$alpha-21:n_1032| 0 0 0 |$alpha-17:m_1031| 0 0 0) (not (= 0 0)) (> |$alpha-17:m_1031| 0) (> |$alpha-21:n_1032| 0) (>= (+ (+ 0 0) |$alpha-21:n_1032|) 0) (> (+ (+ 0 0) 0) (+ (+ 0 0) |$alpha-21:n_1032|)) )
      (|ack_1030$unknown:9| |$knormal:69| |$alpha-21:n_1032| 0 0 0 |$alpha-17:m_1031| 0 0 0)
    )
  )
)
(assert
  (forall ( (|$alpha-17:m_1031| Int) (|$alpha-21:n_1032| Int) (|$knormal:69| Int) )
    (=>
      ( and (|ack_without_checking_1087$unknown:18| |$knormal:69| |$alpha-21:n_1032| 0 0 0 |$alpha-17:m_1031| 0 0 0) (> |$alpha-17:m_1031| 0) (> |$alpha-21:n_1032| 0) (not (not (= 0 0))) )
      (|ack_1030$unknown:9| |$knormal:69| |$alpha-21:n_1032| 0 0 0 |$alpha-17:m_1031| 0 0 0)
    )
  )
)
(assert
  (forall ( (|$alpha-27:m_1035| Int) (|$alpha-28:n_1036| Int) (|$knormal:107| Int) )
    (=>
      ( and (|ack_1030$unknown:9| |$knormal:107| |$alpha-28:n_1036| 0 0 0 |$alpha-27:m_1035| 0 0 0) (> |$alpha-27:m_1035| 0) (> |$alpha-28:n_1036| 0) )
...
(assert
  (forall ( (|$alpha-27:m_1035| Int) (|$alpha-28:n_1036| Int) )
    (=>
      ( and (not (and (> |$alpha-28:n_1036| 0) (> |$alpha-27:m_1035| 0))) )
