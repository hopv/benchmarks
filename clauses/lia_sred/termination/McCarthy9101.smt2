...
(assert
  (forall ( (|$alpha-10:n_1031| Int) (|$knormal:20| Int) (|$knormal:34| Int) (|$knormal:36| Int) )
    (=>
      ( and (not (and (>= (+ 111 (- |$alpha-10:n_1031|)) 0) (> (+ 111 (- 0)) (+ 111 (- |$alpha-10:n_1031|))))) (not (= 0 0)) (|mc91_without_checking_1058$unknown:14| |$knormal:20| |$alpha-10:n_1031| 0 0) (|main_1032$unknown:5| |$alpha-10:n_1031|) (|fail$unknown:4| |$knormal:36| 1) (|bot$unknown:2| |$knormal:34| 1) )
...
(assert
  (not (exists ( (|$cond-alpha-rename:1| Int) )
    ( and (not (and (>= (+ 111 (- |$cond-alpha-rename:1|)) 0) (> (+ 111 (- 0)) (+ 111 (- |$cond-alpha-rename:1|))))) (not (= 0 0)) (|main_1032$unknown:5| |$cond-alpha-rename:1|) )
    )
  )
)
(assert
  (forall ( (|$alpha-10:n_1031| Int) (|$knormal:20| Int) )
    (=>
      ( and (> (+ 111 (- 0)) (+ 111 (- |$alpha-10:n_1031|))) (>= (+ 111 (- |$alpha-10:n_1031|)) 0) (not (= 0 0)) (|mc91_without_checking_1058$unknown:14| |$knormal:20| |$alpha-10:n_1031| 0 0) (|main_1032$unknown:5| |$alpha-10:n_1031|) )
      (|mc91_1030$unknown:10| |$knormal:20| |$alpha-10:n_1031| 0 0)
    )
  )
)
