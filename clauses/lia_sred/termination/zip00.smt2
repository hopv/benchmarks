...
(assert
  (forall ( (|$alpha-19:xs_1031| Int) (|$alpha-23:ys_1032| Int) (|$knormal:35| Int) (|$knormal:37| Int) (|$knormal:39| Int) )
    (=>
      ( and (not (= 0 0)) (|zip_without_checking_1077$unknown:25| |$knormal:35| |$alpha-23:ys_1032| 0 0 0 |$alpha-19:xs_1031| 0 0 0) (|main_1035$unknown:6| |$alpha-23:ys_1032| |$alpha-19:xs_1031|) (|fail$unknown:4| |$knormal:39| 1) (|bot$unknown:2| |$knormal:37| 1) )
...
(assert
  (not (exists ( (|$cond-alpha-rename:10| Int) (|$cond-alpha-rename:14| Int) )
    ( and (not (= 0 0)) (|main_1035$unknown:6| |$cond-alpha-rename:14| |$cond-alpha-rename:10|) )
    )
  )
)
(assert
