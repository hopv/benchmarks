...
(assert
  (forall ( (|$alpha-20:prev_set_flag_up_1088| Int) (|$alpha-21:s_prev_up_x_1087| Int) (|$alpha-22:x_1036| Int) (|$cond-alpha-rename:26| Int) (|$cond-alpha-rename:27| Int) (|$knormal:26| Int) (|$knormal:28| Int) (|$knormal:30| Int) )
    (=>
      ( and (|app_1030$unknown:12| |$alpha-22:x_1036| |$alpha-21:s_prev_up_x_1087| |$alpha-20:prev_set_flag_up_1088| 0 0 (+ (* 0 |$cond-alpha-rename:27|) (+ (* 0 |$cond-alpha-rename:26|) 0)) 0 0) (|bot$unknown:15| |$knormal:28| 1) (|fail$unknown:21| |$knormal:30| 1) (|main_1037$unknown:23| |$cond-alpha-rename:27| |$cond-alpha-rename:26|) (|up_without_checking_1115$unknown:32| |$knormal:26| |$alpha-22:x_1036| |$alpha-21:s_prev_up_x_1087| |$alpha-20:prev_set_flag_up_1088|) (not (= 0 |$alpha-20:prev_set_flag_up_1088|)) (< |$cond-alpha-rename:27| 0) (not (> |$cond-alpha-rename:26| 0)) )
...
(assert
  (not (exists ( (|$cond-alpha-rename:23| Int) (|$cond-alpha-rename:24| Int) (|$cond-alpha-rename:25| Int) (|$cond-alpha-rename:39| Int) (|$cond-alpha-rename:40| Int) )
    ( and (|app_1030$unknown:12| |$cond-alpha-rename:25| |$cond-alpha-rename:24| |$cond-alpha-rename:23| 0 0 (+ (* 0 |$cond-alpha-rename:40|) (+ (* 0 |$cond-alpha-rename:39|) 0)) 0 0) (|main_1037$unknown:23| |$cond-alpha-rename:40| |$cond-alpha-rename:39|) (not (= 0 |$cond-alpha-rename:23|)) (< |$cond-alpha-rename:40| 0) (not (> |$cond-alpha-rename:39| 0)) )
    )
  )
)
(assert
...
(assert
  (forall ( (|$alpha-20:prev_set_flag_up_1088| Int) (|$alpha-21:s_prev_up_x_1087| Int) (|$alpha-22:x_1036| Int) (|$cond-alpha-rename:52| Int) (|$cond-alpha-rename:53| Int) (|$knormal:26| Int) )
    (=>
      ( and (|app_1030$unknown:12| |$alpha-22:x_1036| |$alpha-21:s_prev_up_x_1087| |$alpha-20:prev_set_flag_up_1088| 0 0 (+ (* 0 |$cond-alpha-rename:53|) (+ (* 0 |$cond-alpha-rename:52|) 0)) 0 0) (|main_1037$unknown:23| |$cond-alpha-rename:53| |$cond-alpha-rename:52|) (|up_without_checking_1115$unknown:32| |$knormal:26| |$alpha-22:x_1036| |$alpha-21:s_prev_up_x_1087| |$alpha-20:prev_set_flag_up_1088|) (< |$cond-alpha-rename:53| 0) (not (not (= 0 |$alpha-20:prev_set_flag_up_1088|))) (not (> |$cond-alpha-rename:52| 0)) )
      (|up_1032$unknown:28| |$knormal:26| |$alpha-22:x_1036| |$alpha-21:s_prev_up_x_1087| |$alpha-20:prev_set_flag_up_1088|)
    )
  )
)
