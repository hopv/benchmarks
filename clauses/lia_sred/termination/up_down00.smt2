...
(assert
  (forall ( (|$alpha-20:prev_set_flag_up_1088| Int) (|$alpha-21:s_prev_up_x_1087| Int) (|$alpha-22:x_1036| Int) (|$cond-alpha-rename:119| Int) (|$cond-alpha-rename:120| Int) (|$knormal:26| Int) (|$knormal:28| Int) (|$knormal:30| Int) )
    (=>
      ( and (not (> |$cond-alpha-rename:119| 0)) (< |$cond-alpha-rename:120| 0) (not (= 0 |$alpha-20:prev_set_flag_up_1088|)) (|up_without_checking_1115$unknown:32| |$knormal:26| |$alpha-22:x_1036| |$alpha-21:s_prev_up_x_1087| |$alpha-20:prev_set_flag_up_1088|) (|main_1037$unknown:23| |$cond-alpha-rename:120| |$cond-alpha-rename:119|) (|fail$unknown:21| |$knormal:30| 1) (|bot$unknown:15| |$knormal:28| 1) (|app_1030$unknown:12| |$alpha-22:x_1036| |$alpha-21:s_prev_up_x_1087| |$alpha-20:prev_set_flag_up_1088| 0 0 (+ (* 0 |$cond-alpha-rename:120|) (+ (* 0 |$cond-alpha-rename:119|) 0)) 0 0) )
...
(assert
  (not (exists ( (|$cond-alpha-rename:132| Int) (|$cond-alpha-rename:133| Int) (|$cond-alpha-rename:85| Int) (|$cond-alpha-rename:86| Int) (|$cond-alpha-rename:87| Int) )
    ( and (not (> |$cond-alpha-rename:132| 0)) (not (= 0 |$cond-alpha-rename:85|)) (< |$cond-alpha-rename:133| 0) (|main_1037$unknown:23| |$cond-alpha-rename:133| |$cond-alpha-rename:132|) (|app_1030$unknown:12| |$cond-alpha-rename:87| |$cond-alpha-rename:86| |$cond-alpha-rename:85| 0 0 (+ (* 0 |$cond-alpha-rename:133|) (+ (* 0 |$cond-alpha-rename:132|) 0)) 0 0) )
    )
  )
)
(assert
...
(assert
  (forall ( (|$alpha-20:prev_set_flag_up_1088| Int) (|$alpha-21:s_prev_up_x_1087| Int) (|$alpha-22:x_1036| Int) (|$cond-alpha-rename:145| Int) (|$cond-alpha-rename:146| Int) (|$knormal:26| Int) )
    (=>
      ( and (not (> |$cond-alpha-rename:145| 0)) (not (not (= 0 |$alpha-20:prev_set_flag_up_1088|))) (< |$cond-alpha-rename:146| 0) (|up_without_checking_1115$unknown:32| |$knormal:26| |$alpha-22:x_1036| |$alpha-21:s_prev_up_x_1087| |$alpha-20:prev_set_flag_up_1088|) (|main_1037$unknown:23| |$cond-alpha-rename:146| |$cond-alpha-rename:145|) (|app_1030$unknown:12| |$alpha-22:x_1036| |$alpha-21:s_prev_up_x_1087| |$alpha-20:prev_set_flag_up_1088| 0 0 (+ (* 0 |$cond-alpha-rename:146|) (+ (* 0 |$cond-alpha-rename:145|) 0)) 0 0) )
      (|up_1032$unknown:28| |$knormal:26| |$alpha-22:x_1036| |$alpha-21:s_prev_up_x_1087| |$alpha-20:prev_set_flag_up_1088|)
    )
  )
)
