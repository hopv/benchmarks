...
(assert
  (forall ( (|$alpha-10:n_1031| Int) (|$knormal:22| Int) (|$knormal:24| Int) (|$knormal:26| Int) )
    (=>
      ( and (|bot$unknown:2| |$knormal:24| 1) (|fail$unknown:4| |$knormal:26| 1) (|fib_without_checking_1060$unknown:12| |$knormal:22| |$alpha-10:n_1031| 0 0) (|main_1032$unknown:13| |$alpha-10:n_1031|) (not (= 0 0)) )
...
(assert
  (not (exists ( (|$cond-alpha-rename:1| Int) )
    ( and (|main_1032$unknown:13| |$cond-alpha-rename:1|) (not (= 0 0)) )
    )
  )
)
(assert
