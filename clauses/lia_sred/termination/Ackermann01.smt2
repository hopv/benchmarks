...
(assert
  (not (exists ( (|$cond-alpha-rename:40| Int) (|$cond-alpha-rename:44| Int) )
    ( and (|main_1033$unknown:24| |$cond-alpha-rename:44| |$cond-alpha-rename:40|) (not (= 0 0)) (> |$cond-alpha-rename:40| 0) (> |$cond-alpha-rename:44| 0) (not (and (> (+ (+ 0 0) 0) (+ (+ 0 0) |$cond-alpha-rename:44|)) (>= (+ (+ 0 0) |$cond-alpha-rename:44|) 0))) )
    )
  )
)
(assert
