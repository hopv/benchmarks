...
(assert
  (forall ( (|$V-reftype:48| Int) (|$alpha-2:i| Int) (|$knormal:2| Int) (|$alpha-4:j| Int) (|$alpha-3:x| Int) (|$knormal:1| Bool) )
    (=>
      ( and (= |$knormal:1| (= |$alpha-4:j| |$alpha-2:i|)) (= |$V-reftype:48| |$knormal:2|) (not |$knormal:1|) (|update$unknown:21| |$alpha-4:j| |$alpha-3:x| |$alpha-2:i|) true true (|update$unknown:18| |$knormal:2| |$alpha-4:j|) )
      (|update$unknown:22| |$V-reftype:48| |$alpha-4:j| |$alpha-3:x| |$alpha-2:i|)
    )
  )
)
(assert
  (forall ( (|$V-reftype:47| Int) (|$alpha-2:i| Int) (|$alpha-4:j| Int) (|$alpha-3:x| Int) (|$knormal:1| Bool) )
    (=>
      ( and (= |$knormal:1| (= |$alpha-4:j| |$alpha-2:i|)) (= |$V-reftype:47| |$alpha-3:x|) |$knormal:1| (|update$unknown:21| |$alpha-4:j| |$alpha-3:x| |$alpha-2:i|) true true )
