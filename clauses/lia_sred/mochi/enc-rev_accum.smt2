...
(assert
  (forall ( (|$V-reftype:13| Int) (|$knormal:2| Int) (|$knormal:6| Int) (|$alpha-2:m| Int) (|$alpha-1:n| Int) (|$knormal:4| Int) (|$knormal:1| Bool) )
    (=>
      ( and (= |$knormal:4| (+ |$alpha-2:m| 1)) (= |$knormal:2| (- |$alpha-1:n| 1)) (= |$knormal:1| (= |$alpha-1:n| 0)) (= |$V-reftype:13| |$knormal:6|) (not |$knormal:1|) (|rev$unknown:3| |$knormal:6| |$knormal:4| |$knormal:2|) (|rev$unknown:2| |$alpha-2:m| |$alpha-1:n|) true )
...
(assert
  (forall ( (|$V-reftype:10| Int) (|$alpha-1:n| Int) (|$alpha-2:m| Int) (|$knormal:1| Bool) )
    (=>
      ( and (= |$knormal:1| (= |$alpha-1:n| 0)) (= |$V-reftype:10| |$alpha-2:m|) |$knormal:1| (|rev$unknown:2| |$alpha-2:m| |$alpha-1:n|) true )
...
(assert
  (forall ( (|$knormal:1| Bool) (|$alpha-2:m| Int) (|$alpha-1:n| Int) (|$knormal:2| Int) (|$knormal:4| Int) )
    (=>
      ( and (= |$knormal:4| (+ |$alpha-2:m| 1)) (= |$knormal:2| (- |$alpha-1:n| 1)) (= |$knormal:1| (= |$alpha-1:n| 0)) (not |$knormal:1|) (|rev$unknown:2| |$alpha-2:m| |$alpha-1:n|) true )
