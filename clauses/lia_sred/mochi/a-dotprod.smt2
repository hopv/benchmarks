...
(assert
  (forall ( (|$alpha-9:z| Int) (|$knormal:21| Bool) (|$V-reftype:3| Int) (|$alpha-10:n| Int) )
    (=>
      ( and (= |$knormal:21| (= |$alpha-9:z| 0)) |$knormal:21| (|dotprod$unknown:2| |$V-reftype:3| |$alpha-10:n|) )
      (|make_array$unknown:10| |$V-reftype:3| |$alpha-10:n|)
    )
  )
)
(assert
  (forall ( (|$cond-alpha-rename:4| Bool) (|$cond-alpha-rename:3| Bool) (|$knormal:21| Bool) (|$alpha-10:n| Int) (|$knormal:32| Int) (|$cond-alpha-rename:5| Bool) (|$V-reftype:25| Int) (|$alpha-9:z| Int) )
    (=>
      ( and (= |$knormal:21| (= |$alpha-9:z| 0)) (= |$cond-alpha-rename:5| (and |$cond-alpha-rename:3| |$cond-alpha-rename:4|)) (= |$cond-alpha-rename:4| (< |$knormal:32| |$alpha-10:n|)) (= |$cond-alpha-rename:3| (<= 0 |$knormal:32|)) (= |$V-reftype:25| 0) |$knormal:21| |$cond-alpha-rename:5| (|make_array$unknown:10| |$knormal:32| |$alpha-10:n|) (|dotprod$unknown:2| |$knormal:32| |$alpha-10:n|) )
...
(assert
  (forall ( (|$alpha-9:z| Int) (|$knormal:21| Bool) (|$V-reftype:7| Int) (|$alpha-10:n| Int) )
    (=>
      ( and (= |$knormal:21| (= |$alpha-9:z| 0)) |$knormal:21| (|dotprod$unknown:4| |$V-reftype:7| |$alpha-10:n|) )
      (|make_array$unknown:10| |$V-reftype:7| |$alpha-10:n|)
    )
  )
)
(assert
  (forall ( (|$cond-alpha-rename:7| Bool) (|$cond-alpha-rename:6| Bool) (|$knormal:21| Bool) (|$alpha-10:n| Int) (|$knormal:31| Int) (|$cond-alpha-rename:8| Bool) (|$V-reftype:25| Int) (|$alpha-9:z| Int) )
    (=>
      ( and (= |$knormal:21| (= |$alpha-9:z| 0)) (= |$cond-alpha-rename:8| (and |$cond-alpha-rename:6| |$cond-alpha-rename:7|)) (= |$cond-alpha-rename:7| (< |$knormal:31| |$alpha-10:n|)) (= |$cond-alpha-rename:6| (<= 0 |$knormal:31|)) (= |$V-reftype:25| 0) |$knormal:21| |$cond-alpha-rename:8| (|make_array$unknown:10| |$knormal:31| |$alpha-10:n|) (|dotprod$unknown:4| |$knormal:31| |$alpha-10:n|) )
