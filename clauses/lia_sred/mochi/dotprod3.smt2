...
(assert
  (forall ( (|$alpha-13:n| Int) (|$knormal:35| Int) )
    (=>
      ( and (<= 0 |$knormal:35|) (< |$knormal:35| |$alpha-13:n|) (|make_array$unknown:10| |$knormal:35| |$alpha-13:n|) (|dotprod$unknown:2| |$knormal:35| |$alpha-13:n|) )
...
(assert
  (forall ( (|$alpha-13:n| Int) (|$knormal:34| Int) )
    (=>
      ( and (<= 0 |$knormal:34|) (< |$knormal:34| |$alpha-13:n|) (|make_array$unknown:10| |$knormal:34| |$alpha-13:n|) (|dotprod$unknown:4| |$knormal:34| |$alpha-13:n|) )
...
(assert
  (forall ( (|$alpha-5:i| Int) (|$alpha-6:x| Int) (|$alpha-7:j| Int) (|$knormal:5| Int) )
    (=>
      ( and (not (= |$alpha-5:i| |$alpha-7:j|)) (|update$unknown:13| |$knormal:5| |$alpha-5:i|) )
...
(assert
  (forall ( (|$alpha-6:x| Int) (|$alpha-7:j| Int) )
    (=>
      ( and true )
      (|update$unknown:17| |$alpha-6:x| |$alpha-7:j| |$alpha-6:x| |$alpha-7:j|)
    )
  )
)
(assert
