...
(assert
  (forall ( (|$V-reftype:18| Int) (|$alpha-14:n| Int) (|$alpha-15:m| Int) )
    (=>
      ( and (<= |$alpha-14:n| |$alpha-15:m|) (|bcopy_aux$unknown:10| |$V-reftype:18| |$alpha-14:n|) )
...
(assert
  (forall ( (|$alpha-14:n| Int) (|$alpha-15:m| Int) (|$knormal:44| Int) )
    (=>
      ( and (<= |$alpha-14:n| |$alpha-15:m|) (<= 0 |$knormal:44|) (< |$knormal:44| |$alpha-14:n|) (|make_array$unknown:17| |$knormal:44| |$alpha-14:n|) (|bcopy_aux$unknown:10| |$knormal:44| |$alpha-14:n|) )
...
(assert
  (forall ( (|$V-reftype:22| Int) (|$alpha-14:n| Int) (|$alpha-15:m| Int) (|$cond-alpha-rename:52| Int) (|$cond-alpha-rename:54| Int) )
    (=>
      ( and (|bcopy_aux$unknown:11| |$cond-alpha-rename:54| |$cond-alpha-rename:52| |$alpha-14:n|) (|bcopy_aux$unknown:14| |$cond-alpha-rename:52| |$alpha-14:n|) (|update$unknown:21| |$V-reftype:22| |$alpha-14:n| |$cond-alpha-rename:52|) (not (>= |$cond-alpha-rename:52| |$alpha-14:n|)) (<= |$alpha-14:n| |$alpha-15:m|) )
      (|make_array$unknown:17| |$V-reftype:22| |$alpha-15:m|)
    )
  )
)
(assert
  (forall ( (|$alpha-14:n| Int) (|$alpha-15:m| Int) (|$cond-alpha-rename:56| Int) (|$cond-alpha-rename:58| Int) (|$knormal:43| Int) )
    (=>
      ( and (<= |$alpha-14:n| |$alpha-15:m|) (not (>= |$cond-alpha-rename:56| |$alpha-14:n|)) (<= 0 |$knormal:43|) (< |$knormal:43| |$alpha-15:m|) (|update$unknown:21| |$knormal:43| |$alpha-14:n| |$cond-alpha-rename:56|) (|make_array$unknown:17| |$knormal:43| |$alpha-15:m|) (|bcopy_aux$unknown:14| |$cond-alpha-rename:56| |$alpha-14:n|) (|bcopy_aux$unknown:11| |$cond-alpha-rename:58| |$cond-alpha-rename:56| |$alpha-14:n|) )
