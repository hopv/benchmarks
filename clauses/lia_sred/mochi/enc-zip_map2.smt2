...
(assert
  (forall ( (|$V-reftype:24| Int) (|$knormal:2| Bool) (|$knormal:6| Int) (|$alpha-2:x| Int) (|$alpha-3:y| Int) (|$knormal:8| Int) (|$knormal:4| Int) (|$knormal:3| Bool) )
    (=>
      ( and (= |$knormal:6| (- |$alpha-3:y| 1)) (= |$knormal:4| (- |$alpha-2:x| 1)) (= |$knormal:3| (= |$alpha-3:y| 0)) (= |$knormal:2| (= |$alpha-2:x| 0)) (= |$V-reftype:24| (+ 1 |$knormal:8|)) (not |$knormal:3|) (not |$knormal:2|) (|zip$unknown:7| |$knormal:8| |$knormal:6| |$knormal:4|) (|zip$unknown:6| |$alpha-3:y| |$alpha-2:x|) true )
...
(assert
  (forall ( (|$V-reftype:18| Int) (|$knormal:10| Bool) (|$alpha-3:y| Int) (|$alpha-2:x| Int) (|$knormal:2| Bool) )
    (=>
      ( and (= |$knormal:2| (= |$alpha-2:x| 0)) (= |$knormal:10| (= |$alpha-3:y| 0)) (= |$V-reftype:18| |$alpha-2:x|) |$knormal:2| |$knormal:10| (|zip$unknown:6| |$alpha-3:y| |$alpha-2:x|) true )
...
(assert
  (not (exists ( (|$knormal:10| Bool) (|$alpha-2:x| Int) (|$alpha-3:y| Int) (|$knormal:2| Bool) )
    ( and (= |$knormal:2| (= |$alpha-2:x| 0)) (= |$knormal:10| (= |$alpha-3:y| 0)) (not |$knormal:10|) |$knormal:2| (|zip$unknown:6| |$alpha-3:y| |$alpha-2:x|) true )
    )
  )
)
(assert
  (not (exists ( (|$knormal:2| Bool) (|$alpha-2:x| Int) (|$alpha-3:y| Int) (|$knormal:3| Bool) )
    ( and (= |$knormal:3| (= |$alpha-3:y| 0)) (= |$knormal:2| (= |$alpha-2:x| 0)) (not |$knormal:2|) |$knormal:3| (|zip$unknown:6| |$alpha-3:y| |$alpha-2:x|) true )
    )
  )
)
(assert
