...
(assert
  (not (exists ( (|$alpha-4:n| Int) (|$alpha-5:a| Int) (|$alpha-6:b| Int) (|$knormal:24| Int) )
    ( and (|gib$unknown:4| |$knormal:24| |$alpha-4:n| |$alpha-6:b| |$alpha-5:a|) (>= |$alpha-6:b| 0) (>= |$alpha-5:a| 0) (not (>= |$knormal:24| 0)) )
    )
  )
)
(check-sat)
