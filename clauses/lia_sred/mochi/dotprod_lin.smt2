...
(assert
  (forall ( (|$cond-alpha-rename:4| Bool) (|$cond-alpha-rename:3| Bool) (|$knormal:37| Bool) (|$alpha-10:n| Int) (|$knormal:48| Int) (|$cond-alpha-rename:5| Bool) (|$V-reftype:27| Int) (|$alpha-12:z| Int) )
    (=>
      ( and (= |$knormal:37| (= |$alpha-12:z| 0)) (= |$cond-alpha-rename:5| (and |$cond-alpha-rename:3| |$cond-alpha-rename:4|)) (= |$cond-alpha-rename:4| (< |$knormal:48| |$alpha-10:n|)) (= |$cond-alpha-rename:3| (<= 0 |$knormal:48|)) (= |$V-reftype:27| 0) |$knormal:37| |$cond-alpha-rename:5| (|make_array$unknown:10| |$knormal:48| |$alpha-10:n|) (|dotprod$unknown:2| |$knormal:48| |$alpha-10:n|) )
...
(assert
  (forall ( (|$cond-alpha-rename:7| Bool) (|$cond-alpha-rename:6| Bool) (|$knormal:37| Bool) (|$alpha-10:n| Int) (|$knormal:47| Int) (|$cond-alpha-rename:8| Bool) (|$V-reftype:27| Int) (|$alpha-12:z| Int) )
    (=>
      ( and (= |$knormal:37| (= |$alpha-12:z| 0)) (= |$cond-alpha-rename:8| (and |$cond-alpha-rename:6| |$cond-alpha-rename:7|)) (= |$cond-alpha-rename:7| (< |$knormal:47| |$alpha-10:n|)) (= |$cond-alpha-rename:6| (<= 0 |$knormal:47|)) (= |$V-reftype:27| 0) |$knormal:37| |$cond-alpha-rename:8| (|make_array$unknown:10| |$knormal:47| |$alpha-10:n|) (|dotprod$unknown:4| |$knormal:47| |$alpha-10:n|) )
