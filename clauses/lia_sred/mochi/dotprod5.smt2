...
(assert
  (forall ( (|$alpha-14:m| Int) (|$knormal:34| Bool) (|$knormal:33| Bool) (|$cond-alpha-rename:38| Bool) (|$cond-alpha-rename:37| Bool) (|$knormal:35| Bool) (|$alpha-13:n| Int) (|$knormal:44| Int) (|$cond-alpha-rename:39| Bool) (|$V-reftype:40| Int) (|$alpha-15:i| Int) )
    (=>
      ( and (= |$knormal:35| (and |$knormal:33| |$knormal:34|)) (= |$knormal:34| (<= |$alpha-13:n| |$alpha-14:m|)) (= |$knormal:33| (= |$alpha-15:i| 0)) (= |$cond-alpha-rename:39| (and |$cond-alpha-rename:37| |$cond-alpha-rename:38|)) (= |$cond-alpha-rename:38| (< |$knormal:44| |$alpha-13:n|)) (= |$cond-alpha-rename:37| (<= 0 |$knormal:44|)) (= |$V-reftype:40| 0) |$knormal:35| |$cond-alpha-rename:39| (|make_array$unknown:17| |$knormal:44| |$alpha-13:n|) (|bcopy_aux$unknown:10| |$knormal:44| |$alpha-13:n|) )
...
(assert
  (forall ( (|$alpha-15:i| Int) (|$knormal:35| Bool) (|$alpha-13:n| Int) (|$cond-alpha-rename:27| Int) (|$cond-alpha-rename:25| Int) (|$V-reftype:22| Int) (|$cond-alpha-rename:26| Bool) (|$cond-alpha-rename:28| Int) (|$knormal:33| Bool) (|$knormal:34| Bool) (|$alpha-14:m| Int) )
    (=>
      ( and (= |$knormal:35| (and |$knormal:33| |$knormal:34|)) (= |$knormal:34| (<= |$alpha-13:n| |$alpha-14:m|)) (= |$knormal:33| (= |$alpha-15:i| 0)) (= |$cond-alpha-rename:28| (+ |$cond-alpha-rename:25| 1)) (= |$cond-alpha-rename:26| (>= |$cond-alpha-rename:25| |$alpha-13:n|)) (not |$cond-alpha-rename:26|) |$knormal:35| (|update$unknown:21| |$V-reftype:22| |$alpha-13:n| |$cond-alpha-rename:25|) (|bcopy_aux$unknown:14| |$cond-alpha-rename:25| |$alpha-13:n|) (|bcopy_aux$unknown:11| |$cond-alpha-rename:27| |$cond-alpha-rename:25| |$alpha-13:n|) )
      (|make_array$unknown:17| |$V-reftype:22| |$alpha-14:m|)
    )
  )
)
(assert
  (forall ( (|$knormal:34| Bool) (|$knormal:33| Bool) (|$cond-alpha-rename:41| Bool) (|$cond-alpha-rename:40| Bool) (|$cond-alpha-rename:32| Int) (|$V-reftype:40| Int) (|$knormal:35| Bool) (|$knormal:43| Int) (|$cond-alpha-rename:29| Int) (|$cond-alpha-rename:31| Int) (|$alpha-13:n| Int) (|$alpha-14:m| Int) (|$cond-alpha-rename:42| Bool) (|$cond-alpha-rename:30| Bool) (|$alpha-15:i| Int) )
    (=>
      ( and (= |$knormal:35| (and |$knormal:33| |$knormal:34|)) (= |$knormal:34| (<= |$alpha-13:n| |$alpha-14:m|)) (= |$knormal:33| (= |$alpha-15:i| 0)) (= |$cond-alpha-rename:42| (and |$cond-alpha-rename:40| |$cond-alpha-rename:41|)) (= |$cond-alpha-rename:41| (< |$knormal:43| |$alpha-14:m|)) (= |$cond-alpha-rename:40| (<= 0 |$knormal:43|)) (= |$cond-alpha-rename:32| (+ |$cond-alpha-rename:29| 1)) (= |$cond-alpha-rename:30| (>= |$cond-alpha-rename:29| |$alpha-13:n|)) (= |$V-reftype:40| 0) (not |$cond-alpha-rename:30|) |$knormal:35| |$cond-alpha-rename:42| (|update$unknown:21| |$knormal:43| |$alpha-13:n| |$cond-alpha-rename:29|) (|make_array$unknown:17| |$knormal:43| |$alpha-14:m|) (|bcopy_aux$unknown:14| |$cond-alpha-rename:29| |$alpha-13:n|) (|bcopy_aux$unknown:11| |$cond-alpha-rename:31| |$cond-alpha-rename:29| |$alpha-13:n|) )
