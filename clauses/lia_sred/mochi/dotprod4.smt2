...
(assert
  (forall ( (|$V-reftype:3| Int) (|$alpha-9:n| Int) )
    (=>
      ( and (|dotprod$unknown:2| |$V-reftype:3| |$alpha-9:n|) )
...
(assert
  (forall ( (|$alpha-9:n| Int) (|$knormal:32| Int) )
    (=>
      ( and (<= 0 |$knormal:32|) (< |$knormal:32| |$alpha-9:n|) (|make_array$unknown:10| |$knormal:32| |$alpha-9:n|) (|dotprod$unknown:2| |$knormal:32| |$alpha-9:n|) )
      (|dotprod$unknown:3| 0 |$knormal:32| |$alpha-9:n|)
    )
  )
)
(assert
  (forall ( (|$V-reftype:7| Int) (|$alpha-9:n| Int) )
    (=>
      ( and (|dotprod$unknown:4| |$V-reftype:7| |$alpha-9:n|) )
...
(assert
  (forall ( (|$alpha-9:n| Int) (|$knormal:31| Int) )
    (=>
      ( and (<= 0 |$knormal:31|) (< |$knormal:31| |$alpha-9:n|) (|make_array$unknown:10| |$knormal:31| |$alpha-9:n|) (|dotprod$unknown:4| |$knormal:31| |$alpha-9:n|) )
