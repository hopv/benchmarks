...
(assert
  (forall ( (|$V-reftype:5| Int) (|$alpha-6:x| Int) (|$alpha-7:k| Int) (|$alpha-8:r| Int) (|$cond-alpha-rename:4| Int) )
    (=>
      ( and (|m$unknown:10| |$alpha-7:k| |$alpha-8:r|) (|m$unknown:10| |$alpha-7:k| |$cond-alpha-rename:4|) (|m$unknown:10| |$alpha-8:r| (+ |$alpha-6:x| 11)) (|m$unknown:10| |$cond-alpha-rename:4| (+ |$alpha-6:x| 11)) (|m$unknown:11| |$V-reftype:5| |$alpha-7:k| |$alpha-6:x|) (not (> |$alpha-6:x| 100)) (not (> |$alpha-6:x| 100)) (not (> |$alpha-6:x| 100)) )
...
(assert
  (forall ( (|$alpha-1:x| Int) (|$cond-alpha-rename:22| Int) (|$knormal:4| Int) )
    (=>
      ( and (|m$unknown:10| |$knormal:4| (+ |$alpha-1:x| 11)) (|m$unknown:10| |$knormal:4| (+ |$alpha-1:x| 11)) (|m$unknown:12| |$cond-alpha-rename:22| |$knormal:4|) (not (> |$alpha-1:x| 100)) (not (> |$alpha-1:x| 100)) )
      (|m$unknown:11| |$cond-alpha-rename:22| |$knormal:4| (+ |$alpha-1:x| 11))
    )
  )
)
(assert
  (forall ( (|$alpha-4:n| Int) (|$alpha-5:r| Int) )
    (=>
      ( and (|m$unknown:10| |$alpha-5:r| |$alpha-4:n|) (<= |$alpha-4:n| 101) (= |$alpha-5:r| 91) )
...
(assert
  (not (exists ( (|$alpha-4:n| Int) (|$alpha-5:r| Int) )
    ( and (|m$unknown:10| |$alpha-5:r| |$alpha-4:n|) (<= |$alpha-4:n| 101) (not (= |$alpha-5:r| 91)) )
    )
  )
)
(assert
  (forall ( (|$alpha-4:n| Int) (|$alpha-5:r| Int) )
    (=>
      ( and (|m$unknown:10| |$alpha-5:r| |$alpha-4:n|) (not (<= |$alpha-4:n| 101)) )
      (|$innerFunc:2-k$unknown:8| 1 |$alpha-5:r| |$alpha-4:n|)
    )
  )
)
(assert
  (forall ( (|$V-reftype:14| Int) (|$alpha-3:n| Int) (|$knormal:12| Int) )
    (=>
      ( and (|$innerFunc:2-k$unknown:8| |$V-reftype:14| |$knormal:12| |$alpha-3:n|) (|m$unknown:10| |$knormal:12| |$alpha-3:n|) )
