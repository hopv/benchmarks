...
(assert
  (not (exists ( (|$cond-alpha-rename:442| Int) )
    ( and (|main_1041$unknown:39| |$cond-alpha-rename:442|) (not (= 0 0)) (>= |$cond-alpha-rename:442| 0) (not (and (>= |$cond-alpha-rename:442| 0) (> 0 |$cond-alpha-rename:442|))) )
    )
  )
)
(assert
