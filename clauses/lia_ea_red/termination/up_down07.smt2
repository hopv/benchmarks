...
(assert
  (not (exists ( (|$cond-alpha-rename:324| Int) (|$cond-alpha-rename:325| Int) )
    ( and (|main_1037$unknown:45| |$cond-alpha-rename:325| |$cond-alpha-rename:324|) (not (= 0 0)) (> |$cond-alpha-rename:324| 0) )
    )
  )
)
(assert
