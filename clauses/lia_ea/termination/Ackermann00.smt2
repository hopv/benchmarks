...
(assert
  (forall ( (|$V-reftype:70| Int) (|$alpha-24:m_1035| Int) (|$alpha-25:n_1036| Int) (|$alpha-26:set_flag_ack_1075| Int) (|$alpha-27:s_ack_m_1070| Int) (|$alpha-28:s_ack_n_1071| Int) (|$knormal:74| Int) (|$knormal:75| Int) (|$knormal:76| Int) (|$knormal:91| Int) )
    (=>
      ( and (= (not (= 0 |$knormal:76|)) (and (not (= 0 |$knormal:74|)) (not (= 0 |$knormal:75|)))) (= (not (= 0 |$knormal:75|)) (> |$alpha-24:m_1035| 0)) (= (not (= 0 |$knormal:74|)) (> |$alpha-25:n_1036| 0)) (= |$alpha-28:s_ack_n_1071| 0) (= |$alpha-27:s_ack_m_1070| 0) (= |$alpha-26:set_flag_ack_1075| 0) (= |$V-reftype:70| |$knormal:91|) (not (= 0 |$knormal:76|)) (|main_1033$unknown:24| |$alpha-25:n_1036| |$alpha-24:m_1035|) true (|ack_1030$unknown:9| |$knormal:91| |$alpha-25:n_1036| |$alpha-28:s_ack_n_1071| |$alpha-27:s_ack_m_1070| |$alpha-26:set_flag_ack_1075| |$alpha-24:m_1035| |$alpha-28:s_ack_n_1071| |$alpha-27:s_ack_m_1070| |$alpha-26:set_flag_ack_1075|) )
...
(assert
  (forall ( (|$alpha-24:m_1035| Int) (|$alpha-25:n_1036| Int) (|$alpha-26:set_flag_ack_1075| Int) (|$alpha-27:s_ack_m_1070| Int) (|$alpha-28:s_ack_n_1071| Int) (|$knormal:74| Int) (|$knormal:75| Int) (|$knormal:76| Int) )
    (=>
      ( and (= (not (= 0 |$knormal:76|)) (and (not (= 0 |$knormal:74|)) (not (= 0 |$knormal:75|)))) (= (not (= 0 |$knormal:75|)) (> |$alpha-24:m_1035| 0)) (= (not (= 0 |$knormal:74|)) (> |$alpha-25:n_1036| 0)) (= |$alpha-28:s_ack_n_1071| 0) (= |$alpha-27:s_ack_m_1070| 0) (= |$alpha-26:set_flag_ack_1075| 0) (not (= 0 |$knormal:76|)) (|main_1033$unknown:24| |$alpha-25:n_1036| |$alpha-24:m_1035|) true )
      true
    )
  )
)
...
(assert
  (forall ( (|$V-reftype:71| Int) (|$alpha-24:m_1035| Int) (|$alpha-25:n_1036| Int) (|$alpha-26:set_flag_ack_1075| Int) (|$alpha-27:s_ack_m_1070| Int) (|$alpha-28:s_ack_n_1071| Int) (|$knormal:74| Int) (|$knormal:75| Int) (|$knormal:76| Int) )
    (=>
      ( and (= (not (= 0 |$knormal:76|)) (and (not (= 0 |$knormal:74|)) (not (= 0 |$knormal:75|)))) (= (not (= 0 |$knormal:75|)) (> |$alpha-24:m_1035| 0)) (= (not (= 0 |$knormal:74|)) (> |$alpha-25:n_1036| 0)) (= |$alpha-28:s_ack_n_1071| 0) (= |$alpha-27:s_ack_m_1070| 0) (= |$alpha-26:set_flag_ack_1075| 0) (= |$V-reftype:71| 0) (not (not (= 0 |$knormal:76|))) (|main_1033$unknown:24| |$alpha-25:n_1036| |$alpha-24:m_1035|) true )
