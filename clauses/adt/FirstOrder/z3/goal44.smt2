...
(assert
  (forall ( (A Int) (B (List Int)) (C (List Int)) (D (List (Pair Int Int))) (v_4 (List Int)) ) 
    (=>
      (and
        (zip C v_4 D)
        (and (= v_4 nil) (= C (insert A B)) (not (= D nil)))
      )
      incorrect
    )
  )
  ...
  (forall ( (A Int) (B Int) (C (List Int)) (D (List Int)) (E (List (Pair Int Int))) (F (List Int)) (G (List Int)) (H (List (Pair Int Int))) ) 
    (=>
      (and
        (zip F G H)
        (zip C D E)
        (let ((a!1 (not (= E (insert (mk-pair B A) H)))))
  (and (= C (insert B F)) (= D (insert A G)) a!1))
      )
      incorrect
    )
  )
