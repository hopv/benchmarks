...
(declare-fun |findtree| ( Int (Tree Int) Bool ) Bool)
...
(assert
  (forall ( (D (Tree Int)) (G (Tree Int)) (A Int) (C (Tree Int)) (v_4 Bool) ) 
    (=>
      (and
        (and (= C (node A D G)) (= v_4 true))
      )
      (findtree A C v_4)
    )
  )
...
(assert
  (forall ( (A Int) (B (Tree Int)) (C (Tree Int)) (D Int) (E (Tree Int)) (v_5 Bool) (v_6 Bool) ) 
    (=>
      (and
        (findtree D C v_5)
        (and (= v_5 true) (= E (node A C B)) (= v_6 true))
      )
      (findtree D E v_6)
    )
  )
...
(assert
  (forall ( (A Int) (B (Tree Int)) (C (Tree Int)) (D Int) (E (Tree Int)) (v_5 Bool) (v_6 Bool) ) 
    (=>
      (and
        (findtree D C v_5)
        (and (= v_5 true) (= E (node A B C)) (= v_6 true))
      )
      (findtree D E v_6)
    )
  )
...
(assert
  (forall ( (A Int) (B (Tree Int)) (C (Tree Int)) (D Int) (E (Tree Int)) (v_5 Bool) (v_6 Bool) (v_7 Bool) ) 
    (=>
      (and
        (findtree D C v_5)
        (findtree D B v_6)
        (and (= v_5 false) (= v_6 false) (not (= D A)) (= E (node A B C)) (= v_7 false))
      )
      (findtree D E v_7)
    )
  )
