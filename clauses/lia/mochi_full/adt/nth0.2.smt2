...
(assert (forall ((x0 Int)(x1 Int)(var122 Int)(var121 Int)) (=> (and (|make_list[0:0]| x0) (and (|make_list[0:1][0:0]| var121 var122) (and (= x1 (+ 1 var122)) (and (>= x0 0) (= (+ 1 var121) x0))))) (|make_list[0:1][0:0]| x0 x1))))
