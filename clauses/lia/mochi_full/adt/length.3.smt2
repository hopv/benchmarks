...
(assert (forall ((x0 Int)(x1 Int)(var182 Int)(var181 Int)) (=> (and (|make_list[0:0]| x0) (and (|make_list[0:1][0:0]| var181 var182) (and (= x1 (+ 1 var182)) (and (not (= x0 0)) (= (+ 1 var181) x0))))) (|make_list[0:1][0:0]| x0 x1))))
