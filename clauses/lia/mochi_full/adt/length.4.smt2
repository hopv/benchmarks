...
(assert (forall ((x1 Int)(x2 Int)(var280 Int)(var281 Int)) (=> (and (|length[0:2][0:0]| var280 var281) (and (|length[0:0]| x1) (and (<= 1 x1) (and (= (+ 1 var280) x1) (= x2 (+ 1 var281)))))) (|length[0:2][0:0]| x1 x2))))
...
(assert (forall ((x0 Int)(x1 Int)(var283 Int)(var282 Int)) (=> (and (|make_list[0:0]| x0) (and (|make_list[0:1][0:0]| var282 var283) (and (= x1 (+ 1 var283)) (and (not (= x0 0)) (= (+ 1 var282) x0))))) (|make_list[0:1][0:0]| x0 x1))))
