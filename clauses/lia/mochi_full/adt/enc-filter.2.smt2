...
(assert (forall ((x0 Int)(x1 Int)(var42 Int)) (=> (and (|filter[0:2][0:0]| var42 x1) (and (|filter[0:1]| x0) (and (= (+ 1 var42) x0) (not (= x0 0))))) (|filter[0:2][0:0]| x0 x1))))
(assert (forall ((x1 Int)(x0 Int)) (=> (and (|filter[0:1]| x1) (and (= x0 0) (= x1 0))) (|filter[0:2][0:0]| x1 x0))))
(assert (forall ((x0 Int)(x1 Int)) (=> (and (|filter[0:1]| x1) (and (= (+ 1 x0) x1) (not (= x1 0)))) (|filter[0:1]| x0))))
