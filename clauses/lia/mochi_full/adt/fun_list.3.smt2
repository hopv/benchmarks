...
(assert (forall ((x1 Int)(x2 Bool)(var556 Int)(var559 Bool)(var557 Bool)(var558 Int)) (=> (and (|for_all[0:3][0:0]| var556 var557) (and (|for_all[0:2][0:1][0:0]| x1 0 var558) (and (|for_all[0:1]| x1) (and (|for_all[0:0][0:1][0:0]| var558 var559) (and (<= 1 x1) (and (= (+ 1 var556) x1) (= x2 (and var559 var557)))))))) (|for_all[0:3][0:0]| x1 x2))))
...
(assert (forall ((x2 Int)(var560 Int)) (=> (and (|for_all[0:2][0:1][0:0]| var560 0 x2) (and (|for_all[0:1]| var560) (<= 1 var560))) (|for_all[0:0][0:0]| x2))))
...
(assert (forall ((x3 Int)(x4 Int)(x1 Int)(x2 Int)(var564 Int)(var566 Int)(var565 Int)) (=> (and (|map[0:3][0:1][0:0]| x3 var564 x1) (and (|map[0:3][0:0]| var565 var566) (and (|map[0:3][0:0]| x3 x4) (and (|map[0:0][0:1][0:0]| x2) (and (|map[0:1]| x3) (and (= var564 (+ 1 var566)) (and (= x4 (+ 1 var566)) (and (= (+ 1 var565) x3) (and (= x1 0) (<= 1 x3)))))))))) (|map[0:3][0:1][0:1][0:0]| x3 x4 x1 x2))))
...
(assert (forall ((x1 Int)(x2 Int)(var567 Int)(var568 Int)(var569 Int)) (=> (and (|map[0:3][0:0]| var567 var568) (and (|map[0:0][0:1][0:0]| var569) (and (|map[0:1]| x1) (and (<= 1 x1) (and (= (+ 1 var567) x1) (= x2 (+ 1 var568))))))) (|map[0:3][0:0]| x1 x2))))
(assert (forall ((x1 Int)) (=> (|map[0:0][0:0][0:1][0:0]| 0 x1) (|map[0:0][0:1][0:0]| x1))))
(assert (forall ((x2 Int)(x3 Int)(var570 Int)(var572 Int)(var571 Int)) (=> (and (|map[0:3][0:0]| var570 var571) (and (|map[0:2][0:1][0:0][0:1][0:0]| var572 0 x2 x3) (and (|map[0:1]| var572) (and (= (+ 1 var570) var572) (<= 1 var572))))) (|map[0:0][0:0][0:1][0:0]| x2 x3))))
(assert (forall ((x4 Int)(x1 Int)(x2 Int)(x3 Int)) (=> (and (|map[0:1]| x4) (and (|map[0:2][0:0]| 3 x1) (and (|map[0:2][0:1][0:0][0:0]| 3 0 x2) (and (= x4 3) (and (= x1 0) (= x3 x2)))))) (|map[0:2][0:1][0:0][0:1][0:0]| x4 x1 x2 x3))))
(assert (forall ((x2 Int)(x3 Int)(x1 Int)(var573 Int)(var574 Int)) (=> (and (|map[0:2][0:0]| x2 x3) (and (|map[0:3][0:0]| var573 var574) (and (|map[0:0][0:0][0:0]| x1) (and (|map[0:1]| x2) (and (= x3 0) (and (<= 1 x2) (= (+ 1 var573) x2))))))) (|map[0:2][0:1][0:0][0:0]| x2 x3 x1))))
