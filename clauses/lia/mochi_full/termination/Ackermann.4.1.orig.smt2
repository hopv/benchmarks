...
(declare-fun |fail_4886[34:0]| ( Int) Bool)
(declare-fun |ack_without_checking_92[20:7]| ( Bool  Int  Int  Int  Bool  Int  Int  Int) Bool)
(assert (not (exists ((x0 Int)) (|fail_4886[34:0]| x0))))
(assert (forall ((x0 Int)(x8 Int)(x4 Int)(var20 Bool)(var21 Int)(var22 Int)(var23 Bool)(var24 Int)(var25 Int)) (=> (and (|ack_without_checking_92[20:7]| var20 var21 var22 x4 var23 var24 var25 x8) (and (<= (+ 1 x8) 0) (not (= x4 0)))) (|fail_4886[34:0]| x0))))
