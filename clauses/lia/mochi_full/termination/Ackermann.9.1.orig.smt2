...
(declare-fun |fail_20621[34:0]| ( Int) Bool)
(declare-fun |ack_without_checking_92[20:7]| ( Bool  Int  Int  Int  Bool  Int  Int  Int) Bool)
(assert (not (exists ((x0 Int)) (|fail_20621[34:0]| x0))))
(assert (forall ((x0 Int)(x7 Int)(var20 Bool)(var21 Int)(var22 Int)(var23 Bool)(var24 Int)(var25 Int)) (=> (and (|ack_without_checking_92[20:7]| var20 var21 var22 x7 var23 var24 var25 0) (<= (+ 1 x7) 0)) (|fail_20621[34:0]| x0))))
