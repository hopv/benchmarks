...
(assert (forall ((x0 Int)(var105 Int)(var102 Int)(x1 Int)(x2 Int)(var103 Bool)(var104 Int)) (=> (and (|app[0:8][0:2]| true var105 var102 true var105 0 true var105 true x1 x2) (and (|f_without_checking_251[0:2]| var103 var104 var105) (>= var105 1))) (|fail_48334[0:0]| x0))))
(assert (forall ((x0 Bool)(x1 Int)(x2 Int)(x3 Bool)(x4 Int)(x5 Int)(x6 Bool)(x7 Int)(x15 Bool)(x16 Int)(x17 Int)(x12 Int)(x8 Bool)(x9 Int)(x10 Int)(x13 Bool)(x14 Int)(x11 Int)) (=> (and (|app[0:14]| x0 x1 x2 x3 x4 x5 x6 x7 x8 x9 x10 x13 x14 x11) (and (|app[0:8][0:2]| x13 x14 x12 x13 x14 0 x13 x14 x15 x16 x17) (and (= (+ 1 x12) x2) (>= x2 0)))) (|app[0:8][0:2]| x0 x1 x2 x3 x4 x5 x6 x7 x15 x16 x17))))
(assert (forall ((x0 Bool)(x1 Int)(x2 Int)(x3 Bool)(x4 Int)(x5 Int)(x6 Bool)(x7 Int)(x15 Bool)(x16 Int)(x17 Int)(x12 Int)(x8 Bool)(x9 Int)(x10 Int)(x13 Bool)(x14 Int)(x11 Int)) (=> (and (|app[0:14]| x0 x1 x2 x3 x4 x5 x6 x7 x8 x9 x10 x13 x14 x11) (and (|app[0:8][0:2]| x13 x14 x12 x13 x14 0 x13 x14 x15 x16 x17) (and (= (+ 1 x12) x2) (>= x2 0)))) (|app[0:8][0:2]| x0 x1 x2 x3 x4 x5 x6 x7 x15 x16 x17))))
...
(assert (forall ((x21 Bool)(x22 Int)(x1 Int)(x6 Bool)(x2 Int)(x0 Int)(x7 Bool)(x3 Int)(x8 Bool)(x4 Int)(x20 Int)(x9 Bool)(x5 Int)(x23 Int)(x12 Int)(x10 Bool)(x11 Int)(x13 Bool)(x14 Int)(x15 Int)(x16 Bool)(x17 Int)(x18 Bool)(x19 Int)) (=> (and (|app[0:14]| x10 x11 x12 x13 x14 x15 x16 x17 x18 x19 x20 x21 x22 x23) (and (= x0 0) (and (= (+ 1 x1) x12) (and (>= x12 0) (and (= x22 x2) (and (= x22 x3) (and (= x22 x4) (and (= x22 x5) (and (= x21 x6) (and (= x21 x7) (and (= x21 x8) (= x21 x9)))))))))))) (|app[0:14]| x21 x22 x1 x6 x2 x0 x7 x3 x8 x4 x20 x9 x5 x23))))
(assert (forall ((x21 Bool)(x22 Int)(x1 Int)(x6 Bool)(x2 Int)(x0 Int)(x7 Bool)(x3 Int)(x8 Bool)(x4 Int)(x20 Int)(x9 Bool)(x5 Int)(x23 Int)(x12 Int)(x10 Bool)(x11 Int)(x13 Bool)(x14 Int)(x15 Int)(x16 Bool)(x17 Int)(x18 Bool)(x19 Int)) (=> (and (|app[0:14]| x10 x11 x12 x13 x14 x15 x16 x17 x18 x19 x20 x21 x22 x23) (and (= x0 0) (and (= (+ 1 x1) x12) (and (>= x12 0) (and (= x22 x2) (and (= x22 x3) (and (= x22 x4) (and (= x22 x5) (and (= x21 x6) (and (= x21 x7) (and (= x21 x8) (= x21 x9)))))))))))) (|app[0:14]| x21 x22 x1 x6 x2 x0 x7 x3 x8 x4 x20 x9 x5 x23))))
