...
(assert (forall ((x1 Int)(x2 Int)(var35 Int)) (=> (and (|f[0:1][0:0]| var35 x2) (and (|f[0:0]| x1) (and (= x1 2) (= (+ 1 var35) (* 2 x1))))) (|f[0:1][0:0]| x1 x2))))
(assert (forall ((x1 Int)(x2 Int)) (=> (and (|f[0:0]| x1) (and (= x2 x1) (>= x1 3))) (|f[0:1][0:0]| x1 x2))))
(assert (forall ((x0 Int)) (=> (and (|f[0:0]| 2) (= x0 3)) (|f[0:0]| x0))))
