...
(assert (forall ((x1 Int)(x2 Int)(x3 Int)(var174 Int)(var173 Int)) (=> (and (|loop[0:2][0:0]| var173 var174 x3) (and (|loop[0:1]| x1 x2) (and (<= x1 0) (and (>= x2 0) (and (= (+ 1 var174) x2) (= (+ 1 var173) x1)))))) (|loop[0:2][0:0]| x1 x2 x3))))
(assert (forall ((x1 Int)(x2 Int)(x0 Int)) (=> (and (|loop[0:1]| x1 x2) (and (<= (+ 1 x2) 0) (= x0 x1))) (|loop[0:2][0:0]| x1 x2 x0))))
(assert (forall ((x1 Int)(x0 Int)(x3 Int)(x2 Int)) (=> (and (|loop[0:1]| x2 x3) (and (= (+ 1 x0) x3) (and (= (+ 1 x1) x2) (and (>= x3 0) (<= x2 0))))) (|loop[0:1]| x1 x0))))
