...
(assert (forall ((x0 Int)(x1 Int)(x2 Int)) (=> (and (|dotprod[0:1][0:0]| x2 x1) (or (>= 0 (+ 1 x1)) (>= x1 x2))) (|fail_16[0:0]| x0))))
(assert (forall ((x1 Int)(x3 Int)(x0 Int)(var128 Int)(x2 Int)(var129 Int)) (=> (and (|dotprod[0:1][0:0]| x1 x3) (and (|dotprod[0:1][0:1][0:0]| x1 x0 var128) (and (|dotprod[0:4]| x1 x0 x2) (and (|dotprod[0:2][0:1][0:0]| x1 x0 var129) (<= (+ 1 x0) x1))))) (|dotprod[0:1][0:0]| x1 x3))))
...
(assert (forall ((x1 Int)(x3 Int)(x2 Int)(var130 Int)) (=> (and (|dotprod[0:4]| x1 x3 x2) (and (|dotprod[0:1][0:1][0:0]| x1 x3 var130) (<= (+ 1 x3) x1))) (|dotprod[0:2][0:0]| x1 x3))))
(assert (forall ((x0 Int)(x1 Int)(x2 Int)) (=> (and (|dotprod[0:1][0:0]| x0 x1) (and (= x2 0) (and (<= 0 x1) (<= (+ 1 x1) x0)))) (|dotprod[0:1][0:1][0:0]| x0 x1 x2))))
(assert (forall ((x0 Int)(x1 Int)(x2 Int)) (=> (and (|dotprod[0:4]| x0 x1 x2) (<= (+ 1 x1) x0)) (|dotprod[0:1][0:0]| x0 x1))))
(assert (forall ((x2 Int)(x0 Int)(x1 Int)) (=> (and (= x0 0) (= x1 0)) (|dotprod[0:4]| x2 x0 x1))))
(check-sat)
(get-model)
(exit)
