...
(assert (forall ((x0 Int)(x2 Int)(x1 Int)) (=> (and (|zip[0:2][0:0]| x1 x1 x2) (not (= x2 x1))) (|fail_15[0:0]| x0))))
(assert (forall ((x1 Int)(x2 Int)(x3 Int)(var39 Int)(var40 Int)(var41 Int)) (=> (and (|zip[0:2][0:0]| var39 var40 var41) (and (|zip[0:1]| x1 x2) (and (not (= x1 0)) (and (= (+ 1 var39) x1) (and (= (+ 1 var40) x2) (and (= x3 (+ 1 var41)) (not (= x2 0)))))))) (|zip[0:2][0:0]| x1 x2 x3))))
