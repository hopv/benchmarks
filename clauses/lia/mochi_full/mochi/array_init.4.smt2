...
(assert (forall ((x3 Int)(x4 Int)(x1 Int)(x2 Int)(x0 Int)(var126 Int)(var125 Int)(var124 Int)) (=> (and (|init[0:1]| x0 x4) (and (|init[0:1]| x3 x4) (and (|init[0:1]| x0 var126) (and (|init[0:2][0:0]| var125 var126 x1) (and (|init[0:1]| x0 var124) (and (|init[0:2][0:1][0:0]| x0 var124 x1 x2) (and (<= (+ 1 x0) var126) (and (= var125 (+ 1 x0)) (and (<= (+ 1 x0) var124) (and (= x3 (+ 1 x0)) (and (<= (+ 1 x0) x4) (not (= x1 x0))))))))))))) (|init[0:2][0:1][0:0]| x3 x4 x1 x2))))
(assert (forall ((x3 Int)(x4 Int)(x1 Int)(x2 Int)(var128 Int)(var127 Int)) (=> (and (|init[0:1]| x1 x4) (and (|init[0:1]| x3 x4) (and (|init[0:1]| x1 var128) (and (|init[0:2][0:0]| var127 var128 x1) (and (<= (+ 1 x1) var128) (and (= var127 (+ 1 x1)) (and (= x2 1) (and (= x3 (+ 1 x1)) (<= (+ 1 x1) x4))))))))) (|init[0:2][0:1][0:0]| x3 x4 x1 x2))))
(assert (forall ((x1 Int)(x0 Int)(x2 Int)(var130 Int)(var129 Int)) (=> (and (|init[0:1]| x1 x0) (and (|init[0:1]| x1 var130) (and (|init[0:2][0:0]| var129 var130 x2) (and (<= (+ 1 x1) var130) (and (= var129 (+ 1 x1)) (and (<= (+ 1 x1) x0) (not (= x2 x1)))))))) (|init[0:2][0:0]| x1 x0 x2))))
