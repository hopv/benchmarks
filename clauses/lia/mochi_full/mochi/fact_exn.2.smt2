...
(assert (forall ((x0 Int)(x1 Int)(var45 Int)) (=> (and (|fact[0:0]| x0) (and (|fact[0:1][0:0]| var45 x1) (and (not (= x1 0)) (and (>= x0 1) (= (+ 1 var45) x0))))) (|fact[0:1][0:0]| x0 x1))))
(assert (forall ((x1 Int)(x0 Int)) (=> (and (|fact[0:0]| x1) (and (= x0 0) (<= x1 0))) (|fact[0:1][0:0]| x1 x0))))
(assert (forall ((x0 Int)(x1 Int)) (=> (and (|fact[0:0]| x1) (and (= (+ 1 x0) x1) (>= x1 1))) (|fact[0:0]| x0))))
