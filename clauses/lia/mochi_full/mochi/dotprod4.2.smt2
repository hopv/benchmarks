...
(assert (forall ((x0 Int)(x1 Int)(x2 Int)) (=> (and (|dotprod[0:2][0:0]| x2 x1) (or (>= 0 (+ 1 x1)) (>= x1 x2))) (|fail_21[0:0]| x0))))
(assert (forall ((x1 Int)(x3 Int)(x2 Int)(var77 Int)) (=> (and (|dotprod[0:4]| x1 x3 x2) (and (|dotprod[0:1][0:1][0:0]| x1 x3 var77) (<= (+ 1 x3) x1))) (|dotprod[0:2][0:0]| x1 x3))))
...
(assert (forall ((x1 Int)(x2 Int)(x0 Int)) (=> (and (= x2 0) (= x2 x0)) (|dotprod[0:4]| x1 x2 x0))))
(check-sat)
(get-model)
(exit)
