...
(assert (forall ((x0 Int)(x4 Int)(x1 Int)(x2 Int)(x3 Int)) (=> (and (|gib[112:3][138:0]| x1 x2 x3 x4) (and (<= (+ 1 x4) 0) (and (>= x1 0) (>= x2 0)))) (|fail_23[143:0]| x0))))
...
(assert (forall ((x1 Int)(x2 Int)(x0 Int)) (=> (and (>= x1 0) (>= x2 0)) (|gib[112:2]| x1 x2 x0))))
(check-sat)
(get-model)
(exit)
