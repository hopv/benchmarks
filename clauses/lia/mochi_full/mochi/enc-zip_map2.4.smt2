...
(assert (forall ((x1 Int)(x2 Int)(x3 Int)(var179 Int)(var180 Int)(var181 Int)) (=> (and (|zip[0:2][0:0]| var179 var180 var181) (and (|zip[0:1]| x1 x2) (and (not (= x1 0)) (and (= (+ 1 var179) x1) (and (= (+ 1 var180) x2) (and (= x3 (+ 1 var181)) (not (= x2 0)))))))) (|zip[0:2][0:0]| x1 x2 x3))))
