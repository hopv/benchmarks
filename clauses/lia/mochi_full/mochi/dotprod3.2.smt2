...
(assert (forall ((x0 Int)(x1 Int)(x2 Int)) (=> (and (|dotprod[0:2][0:0]| x2 x1) (or (>= 0 (+ 1 x1)) (>= x1 x2))) (|fail_16[0:0]| x0))))
(assert (forall ((x1 Int)(x3 Int)(x2 Int)(var70 Int)) (=> (and (|dotprod[0:4]| x1 x3 x2) (and (|dotprod[0:1][0:1][0:0]| x1 x3 var70) (<= (+ 1 x3) x1))) (|dotprod[0:2][0:0]| x1 x3))))
