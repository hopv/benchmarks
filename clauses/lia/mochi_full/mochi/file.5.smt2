...
(assert (forall ((x4 Bool)(x5 Int)(x3 Bool)(x0 Int)(x2 Int)(x1 Int)) (=> (and (|read_[0:2][0:0]| x3 x0 x5) (and (|close_[0:2][0:0]| x4 x2 x1) (and (|f[0:2]| x3 x4 x0) (|close_[0:2][0:0]| x3 x0 x2)))) (|read_[0:1]| x4 x5))))
(assert (forall ((x0 Bool)(x1 Int)(x2 Int)) (=> (and (|read_[0:1]| x0 x1) (and (= x2 1) (and (= x1 1) x0))) (|read_[0:2][0:0]| x0 x1 x2))))
...
(assert (forall ((x0 Bool)(x1 Int)(x2 Int)) (=> (and (|close_[0:1]| x0 x1) (and (= x2 2) (and (= x1 1) x0))) (|close_[0:2][0:0]| x0 x1 x2))))
