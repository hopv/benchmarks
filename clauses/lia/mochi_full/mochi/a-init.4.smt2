...
(assert (forall ((x0 Int)(x1 Int)(x3 Int)(x4 Int)) (=> (and (|init[0:3][0:0][0:1][0:0]| 0 x3 x1 x4) (and (<= (+ 1 x1) x3) (and (<= 0 x1) (<= x4 0)))) (|fail_28[0:0]| x0))))
...
(assert (forall ((x3 Int)(x4 Int)(x1 Int)(x2 Int)(x0 Int)(var209 Int)(var208 Int)(var207 Int)) (=> (and (|init[0:1]| x0 x4) (and (|init[0:1]| x3 x4) (and (|init[0:1]| x0 var209) (and (|init[0:2][0:0]| var208 var209 x1) (and (|init[0:1]| x0 var207) (and (|init[0:2][0:1][0:0]| x0 var207 x1 x2) (and (<= (+ 1 x0) var209) (and (= var208 (+ 1 x0)) (and (<= (+ 1 x0) var207) (and (= x3 (+ 1 x0)) (and (<= (+ 1 x0) x4) (or (<= (+ 1 x1) x0) (>= x1 (+ 1 x0)))))))))))))) (|init[0:2][0:1][0:0]| x3 x4 x1 x2))))
(assert (forall ((x3 Int)(x4 Int)(x1 Int)(x2 Int)(var211 Int)(var210 Int)) (=> (and (|init[0:1]| x1 x4) (and (|init[0:1]| x3 x4) (and (|init[0:1]| x1 var211) (and (|init[0:2][0:0]| var210 var211 x1) (and (<= (+ 1 x1) var211) (and (= var210 (+ 1 x1)) (and (= x2 1) (and (= x3 (+ 1 x1)) (<= (+ 1 x1) x4))))))))) (|init[0:2][0:1][0:0]| x3 x4 x1 x2))))
(assert (forall ((x1 Int)(x0 Int)(x2 Int)(var213 Int)(var212 Int)) (=> (and (|init[0:1]| x1 x0) (and (|init[0:1]| x1 var213) (and (|init[0:2][0:0]| var212 var213 x2) (and (<= (+ 1 x1) var213) (and (= var212 (+ 1 x1)) (and (<= (+ 1 x1) x0) (or (<= (+ 1 x2) x1) (>= x2 (+ 1 x1))))))))) (|init[0:2][0:0]| x1 x0 x2))))
