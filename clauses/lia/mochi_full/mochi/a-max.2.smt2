...
(assert (forall ((x2 Int)(x0 Int)(x1 Int)(x3 Int)(var64 Int)(var65 Int)) (=> (and (|array_max[0:4][0:0]| x2 var64 x1 x3) (and (|array_max[0:3]| x2 x0 x1) (and (|array_max[0:2][0:1][0:0]| x2 x0 x0 var65) (and (= var64 (+ 1 x0)) (and (<= var65 x1) (<= (+ 1 x0) x2)))))) (|array_max[0:4][0:0]| x2 x0 x1 x3))))
