...
(assert (forall ((x1 Int)(x2 Int)(x3 Int)(var82 Int)(var83 Int)(var84 Int)) (=> (and (|zip[0:2][0:0]| var82 var83 var84) (and (|zip[0:1]| x1 x2) (and (not (= x1 0)) (and (= (+ 1 var82) x1) (and (= (+ 1 var83) x2) (and (= x3 (+ 1 var84)) (not (= x2 0)))))))) (|zip[0:2][0:0]| x1 x2 x3))))
