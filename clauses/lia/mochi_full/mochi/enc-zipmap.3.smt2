...
(assert (forall ((x0 Int)(x1 Int)(var116 Int)(var115 Int)) (=> (and (|map[0:0]| x0) (and (|map[0:1][0:0]| var115 var116) (and (= x1 (+ 1 var116)) (and (not (= x0 0)) (= (+ 1 var115) x0))))) (|map[0:1][0:0]| x0 x1))))
