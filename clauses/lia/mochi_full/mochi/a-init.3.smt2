...
(assert (forall ((x3 Int)(x4 Int)(x1 Int)(x2 Int)(var138 Int)(var137 Int)) (=> (and (|init[0:1]| x1 x4) (and (|init[0:1]| x3 x4) (and (|init[0:1]| x1 var138) (and (|init[0:2][0:0]| var137 var138 x1) (and (<= (+ 1 x1) var138) (and (= var137 (+ 1 x1)) (and (= x2 1) (and (= x3 (+ 1 x1)) (<= (+ 1 x1) x4))))))))) (|init[0:2][0:1][0:0]| x3 x4 x1 x2))))
