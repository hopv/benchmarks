...
(assert (forall ((x0 Int)(x1 Int)(var124 Int)(var123 Int)) (=> (and (|map[0:0]| x0) (and (|map[0:1][0:0]| var123 var124) (and (= x1 (+ 1 var124)) (and (not (= x0 0)) (= (+ 1 var123) x0))))) (|map[0:1][0:0]| x0 x1))))
