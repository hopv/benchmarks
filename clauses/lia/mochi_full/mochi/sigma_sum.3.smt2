...
(assert (forall ((x0 Int)(x1 Int)(var90 Int)(var89 Int)(var88 Int)) (=> (and (|sigma[0:2][0:0]| var88 var89) (and (|sigma[0:1]| x0) (and (|sigma[0:0][0:1][0:0]| x0 var90) (and (= x1 (+ var90 var89)) (and (= (+ 1 var88) x0) (>= x0 1)))))) (|sigma[0:2][0:0]| x0 x1))))
...
(assert (forall ((x0 Int)(x1 Int)(var92 Int)(var91 Int)) (=> (and (|sum[0:0]| x0) (and (|sum[0:1][0:0]| var91 var92) (and (= x1 (+ x0 var92)) (and (>= x0 1) (= (+ 1 var91) x0))))) (|sum[0:1][0:0]| x0 x1))))
