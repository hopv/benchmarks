...
(assert (forall ((x0 Int)(x1 Int)(x2 Int)(var394 Int)(var395 Int)) (=> (and (|mc91[0:2][0:0]| x0 var395 x2) (and (|mc91[0:1]| x0 x1) (and (|mc91[0:2][0:0]| x0 var394 var395) (and (<= x1 100) (= var394 (+ 11 x1)))))) (|mc91[0:2][0:0]| x0 x1 x2))))
(assert (forall ((x1 Int)(x2 Int)(x0 Int)) (=> (and (|mc91[0:1]| x1 x2) (and (= (+ 10 x0) x2) (>= x2 101))) (|mc91[0:2][0:0]| x1 x2 x0))))
(assert (forall ((x0 Int)(x2 Int)(x1 Int)(var396 Int)) (=> (and (|mc91[0:1]| x0 x1) (and (|mc91[0:2][0:0]| x0 var396 x2) (and (<= x1 100) (= var396 (+ 11 x1))))) (|mc91[0:1]| x0 x2))))
(assert (forall ((x1 Int)(x2 Int)(x0 Int)) (=> (and (|mc91[0:1]| x1 x2) (and (= (+ 10 x0) x2) (>= x2 101))) (|mc91[0:2][0:0]| x1 x2 x0))))
