...
(assert (forall ((x1 Int)(x2 Int)(x0 Int)(x3 Int)(var156 Int)) (=> (and (|assign[0:4][0:0]| x0 x1 x2 x0 x3) (and (|loop[0:2]| x1 x2 x0) (and (|loop[0:3][0:1][0:0]| x1 x2 x0 x1 var156) (>= var156 x2)))) (|loop[0:3][0:0]| x1 x2 x0 x3))))
