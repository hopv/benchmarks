...
(assert (forall ((x1 Int)(x2 Int)(x0 Int)(x3 Int)(var429 Int)) (=> (and (|assign[0:4][0:0]| x0 x1 x2 x0 x3) (and (|loop[0:2]| x1 x2 x0) (and (|loop[0:3][0:1][0:0]| x1 x2 x0 x1 var429) (<= (+ 1 var429) x2)))) (|loop[0:3][0:0]| x1 x2 x0 x3))))
(assert (forall ((x3 Int)(x4 Int)(x5 Int)(x2 Int)(x6 Int)(x0 Int)(var430 Int)(x1 Int)) (=> (and (|assign[0:4][0:1][0:0]| x3 x4 x5 x2 x0 var430) (and (|assign[0:6]| x3 x4 x5 x2 x0 x1) (and (|assign[0:7][0:0][0:0]| x3 x4 x5 x2 x0 x1 x6) (not (= x0 x6))))) (|assign[0:4][0:0]| x3 x4 x5 x2 x6))))
...
(assert (forall ((x1 Int)(x2 Int)(x0 Int)(x3 Int)(var431 Int)) (=> (and (|assign[0:4][0:0]| x0 x1 x2 x0 x3) (and (|loop[0:2]| x1 x2 x0) (and (|loop[0:3][0:1][0:0]| x1 x2 x0 x1 var431) (<= (+ 1 var431) x2)))) (|loop[0:3][0:0]| x1 x2 x0 x3))))
