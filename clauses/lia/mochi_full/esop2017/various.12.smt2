...
(assert (forall ((x1 Int)(x0 Int)(x2 Int)(var854 Int)(var853 Int)) (=> (and (|sum[0:1]| x1 x0) (and (|sum[0:2][0:0]| x1 var853 var854) (and (= x2 (+ x0 var854)) (and (>= x0 1) (= (+ 1 var853) x0))))) (|sum[0:2][0:0]| x1 x0 x2))))
...
(assert (forall ((x0 Int)(x1 Int)) (=> (and (|mult[0:3][0:0]| x0 x0 x0 x1) (and (|mc91[0:2][0:0]| x0 x0 91) (and (<= x0 x1) (<= x0 101)))) (|main_20[0:0]| x0))))
(assert (forall ((x2 Int)(x1 Int)(x0 Int)(x3 Int)(var856 Int)(var855 Int)) (=> (and (|mult[0:2]| x2 x1 x0) (and (|mult[0:3][0:0]| x2 x1 var855 var856) (and (= x3 (+ x1 var856)) (and (>= x1 1) (and (>= x0 1) (= (+ 1 var855) x0)))))) (|mult[0:3][0:0]| x2 x1 x0 x3))))
(assert (forall ((x2 Int)(x1 Int)(x0 Int)(x3 Int)(var858 Int)(var857 Int)) (=> (and (|mult[0:2]| x2 x1 x0) (and (|mult[0:3][0:0]| x2 x1 var857 var858) (and (= x3 (+ x1 var858)) (and (>= x1 1) (and (>= x0 1) (= (+ 1 var857) x0)))))) (|mult[0:3][0:0]| x2 x1 x0 x3))))
(assert (forall ((x2 Int)(x1 Int)(x0 Int)(x3 Int)(var860 Int)(var859 Int)) (=> (and (|mult[0:2]| x2 x1 x0) (and (|mult[0:3][0:0]| x2 x1 var859 var860) (and (= x3 (+ x1 var860)) (and (>= x1 1) (and (>= x0 1) (= (+ 1 var859) x0)))))) (|mult[0:3][0:0]| x2 x1 x0 x3))))
(assert (forall ((x2 Int)(x1 Int)(x0 Int)(x3 Int)(var862 Int)(var861 Int)) (=> (and (|mult[0:2]| x2 x1 x0) (and (|mult[0:3][0:0]| x2 x1 var861 var862) (and (= x3 (+ x1 var862)) (and (>= x1 1) (and (>= x0 1) (= (+ 1 var861) x0)))))) (|mult[0:3][0:0]| x2 x1 x0 x3))))
