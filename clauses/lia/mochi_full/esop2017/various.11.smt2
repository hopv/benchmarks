...
(assert (forall ((x1 Int)(x0 Int)(x2 Int)(var754 Int)(var753 Int)) (=> (and (|sum[0:1]| x1 x0) (and (|sum[0:2][0:0]| x1 var753 var754) (and (= x2 (+ x0 var754)) (and (>= x0 1) (= (+ 1 var753) x0))))) (|sum[0:2][0:0]| x1 x0 x2))))
...
(assert (forall ((x2 Int)(x1 Int)(x0 Int)(x3 Int)(var756 Int)(var755 Int)) (=> (and (|mult[0:2]| x2 x1 x0) (and (|mult[0:3][0:0]| x2 x1 var755 var756) (and (= x3 (+ x1 var756)) (and (>= x1 1) (and (>= x0 1) (= (+ 1 var755) x0)))))) (|mult[0:3][0:0]| x2 x1 x0 x3))))
(assert (forall ((x2 Int)(x1 Int)(x0 Int)(x3 Int)(var758 Int)(var757 Int)) (=> (and (|mult[0:2]| x2 x1 x0) (and (|mult[0:3][0:0]| x2 x1 var757 var758) (and (= x3 (+ x1 var758)) (and (>= x1 1) (and (>= x0 1) (= (+ 1 var757) x0)))))) (|mult[0:3][0:0]| x2 x1 x0 x3))))
(assert (forall ((x2 Int)(x1 Int)(x0 Int)(x3 Int)(var760 Int)(var759 Int)) (=> (and (|mult[0:2]| x2 x1 x0) (and (|mult[0:3][0:0]| x2 x1 var759 var760) (and (= x3 (+ x1 var760)) (and (>= x1 1) (and (>= x0 1) (= (+ 1 var759) x0)))))) (|mult[0:3][0:0]| x2 x1 x0 x3))))
