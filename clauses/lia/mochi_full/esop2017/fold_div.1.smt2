...
(assert (not (exists ((x0 Int)) (|f_37[0:0]| x0))))
(assert (forall ((x0 Int)(var53 Int)(var55 Int)(var54 Int)) (=> (and (|fold_left[0:5][0:0]| var53 var55 x0) (|make_list[0:1][0:0]| var54 var55)) (|f_37[0:0]| x0))))
...
(assert (forall ((x3 Int)(x4 Int)(x5 Int)(x2 Int)(x0 Int)) (=> (and (|make_list[0:1][0:0]| x2 x0) (and (|fold_left[0:0][0:1]| x3 x4) (and (= x5 0) (= x4 0)))) (|fold_left[0:0][0:3][0:0]| x3 x4 x5))))
(assert (forall ((x3 Int)(x4 Int)(var58 Int)) (=> (and (|fold_left[0:3][0:1][0:0]| x3 var58 0 x4) (and (|fold_left[0:2]| x3 var58) (<= 1 var58))) (|fold_left[0:0][0:1]| x3 x4))))
...
(assert (forall ((x2 Int)(x3 Int)(x0 Int)(x1 Int)(var63 Int)(var66 Int)(var65 Int)(var64 Int)) (=> (and (|make_list[0:1][0:1][0:0]| x2 var63 x0) (and (|make_list[0:1][0:0]| var65 var66) (and (|randpos[0:1][0:0]| var64 x1) (and (|make_list[0:1][0:0]| x2 x3) (and (|make_list[0:0]| x2) (and (= var63 (+ 1 var66)) (and (= x3 (+ 1 var66)) (and (= (+ 1 var65) x2) (and (= x0 0) (>= x2 1)))))))))) (|make_list[0:1][0:1][0:1][0:0]| x2 x3 x0 x1))))
...
(assert (forall ((x0 Int)(x2 Int)(x1 Int)) (=> (|make_list[0:1][0:0]| x1 x2) (|fold_left[0:2]| x0 x2))))
(assert (forall ((x0 Int)(x1 Int)(var69 Int)(var70 Int)(var67 Int)(var68 Int)) (=> (and (|randpos[0:1][0:0]| var67 var68) (and (|make_list[0:1][0:0]| var69 var70) (and (|make_list[0:0]| x0) (and (= (+ 1 var69) x0) (and (= x1 (+ 1 var70)) (>= x0 1)))))) (|make_list[0:1][0:0]| x0 x1))))
(assert (forall ((x0 Int)(x1 Int)) (=> (and (|randpos[0:0]| x0) (>= x1 1)) (|randpos[0:1][0:0]| x0 x1))))
(assert (forall ((x0 Int)(x1 Int)(var71 Int)(x2 Int)) (=> (and (|make_list[0:0]| x1) (and (|make_list[0:1][0:0]| var71 x2) (and (>= x1 1) (= (+ 1 var71) x1)))) (|randpos[0:0]| x0))))
