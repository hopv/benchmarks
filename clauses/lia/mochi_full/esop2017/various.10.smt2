...
(assert (forall ((x1 Int)(x0 Int)(x2 Int)(var670 Int)(var669 Int)) (=> (and (|sum[0:1]| x1 x0) (and (|sum[0:2][0:0]| x1 var669 var670) (and (= x2 (+ x0 var670)) (and (>= x0 1) (= (+ 1 var669) x0))))) (|sum[0:2][0:0]| x1 x0 x2))))
...
(assert (forall ((x2 Int)(x1 Int)(x0 Int)(x3 Int)(var672 Int)(var671 Int)) (=> (and (|mult[0:2]| x2 x1 x0) (and (|mult[0:3][0:0]| x2 x1 var671 var672) (and (= x3 (+ x1 var672)) (and (>= x1 1) (and (>= x0 1) (= (+ 1 var671) x0)))))) (|mult[0:3][0:0]| x2 x1 x0 x3))))
(assert (forall ((x2 Int)(x1 Int)(x0 Int)(x3 Int)(var674 Int)(var673 Int)) (=> (and (|mult[0:2]| x2 x1 x0) (and (|mult[0:3][0:0]| x2 x1 var673 var674) (and (= x3 (+ x1 var674)) (and (>= x1 1) (and (>= x0 1) (= (+ 1 var673) x0)))))) (|mult[0:3][0:0]| x2 x1 x0 x3))))
