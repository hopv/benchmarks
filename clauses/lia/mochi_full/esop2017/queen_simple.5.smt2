...
(assert (forall ((x1 Int)(x2 Int)(x0 Int)(x3 Int)(var578 Int)) (=> (and (|assign[0:4][0:0]| x0 x1 x2 x0 x3) (and (|loop[0:2]| x1 x2 x0) (and (|loop[0:3][0:1][0:0]| x1 x2 x0 x1 var578) (<= (+ 1 var578) x2)))) (|loop[0:3][0:0]| x1 x2 x0 x3))))
(assert (forall ((x3 Int)(x4 Int)(x5 Int)(x2 Int)(x6 Int)(x0 Int)(var579 Int)(x1 Int)) (=> (and (|assign[0:4][0:1][0:0]| x3 x4 x5 x2 x0 var579) (and (|assign[0:6]| x3 x4 x5 x2 x0 x1) (and (|assign[0:7][0:0][0:0]| x3 x4 x5 x2 x0 x1 x6) (not (= x0 x6))))) (|assign[0:4][0:0]| x3 x4 x5 x2 x6))))
(assert (forall ((x2 Int)(x3 Int)(x4 Int)(x5 Int)(x6 Int)(x7 Int)(x1 Int)(var580 Int)(x0 Int)) (=> (and (|assign[0:6]| x2 x3 x4 x5 x6 x7) (and (|loop[0:3][0:0]| var580 x4 x2 x1) (and (|loop[0:2]| x3 x4 x2) (and (|loop[0:3][0:1][0:0]| x3 x4 x2 x3 x0) (and (= var580 (+ 1 x3)) (and (<= x7 x4) (and (= x7 (+ 1 x0)) (and (not (= (+ 1 x3) x4)) (and (= x3 x6) (= x2 x5)))))))))) (|assign[0:7][0:0][0:0]| x2 x3 x4 x5 x6 x7 x1))))
(assert (forall ((x1 Int)(x2 Int)(x3 Int)(x0 Int)) (=> (and (|loop[0:2]| x1 x2 x3) (= x0 x1)) (|loop[0:3][0:0]| x1 x2 x3 x0))))
(assert (forall ((x0 Int)(x4 Int)(x1 Int)(x3 Int)(x5 Int)) (=> (and (|loop[0:2]| x3 x4 x1) (and (|loop[0:3][0:1][0:0]| x3 x4 x1 x3 x5) (and (not (= (+ 1 x3) x4)) (and (<= (+ 1 x5) x4) (= x0 (+ 1 x3)))))) (|loop[0:2]| x0 x4 x1))))
...
(assert (forall ((x1 Int)(x2 Int)(x0 Int)(x3 Int)(var581 Int)) (=> (and (|assign[0:4][0:0]| x0 x1 x2 x0 x3) (and (|loop[0:2]| x1 x2 x0) (and (|loop[0:3][0:1][0:0]| x1 x2 x0 x1 var581) (<= (+ 1 var581) x2)))) (|loop[0:3][0:0]| x1 x2 x0 x3))))
