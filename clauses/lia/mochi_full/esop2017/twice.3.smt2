...
(assert (forall ((x1 Int)(x2 Int)(x3 Int)(var91 Int)(var92 Int)) (=> (and (|mult[0:2][0:0]| x1 var91 var92) (and (|mult[0:1]| x1 x2) (and (= var91 (+ 1 x2)) (and (= (+ x3 x1) var92) (<= (+ 1 x2) 0))))) (|mult[0:2][0:0]| x1 x2 x3))))
