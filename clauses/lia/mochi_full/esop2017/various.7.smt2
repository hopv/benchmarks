...
(assert (forall ((x2 Int)(x1 Int)(x0 Int)(x3 Int)(var467 Int)(var466 Int)) (=> (and (|mult[0:2]| x2 x1 x0) (and (|mult[0:3][0:0]| x2 x1 var466 var467) (and (= x3 (+ x1 var467)) (and (>= x1 1) (and (>= x0 1) (= (+ 1 var466) x0)))))) (|mult[0:3][0:0]| x2 x1 x0 x3))))
