...
(declare-fun |fail_83[0:0]| ( Int) Bool)
(declare-fun |aux_45[0:3]| ( Int  Int  Int) Bool)
...
(assert (not (exists ((x0 Int)) (|fail_83[0:0]| x0))))
(assert (forall ((x0 Int)(x2 Int)(x3 Int)(x1 Int)) (=> (and (|aux_45[0:3]| x1 x3 x2) (and (>= 0 (+ 1 x2)) (not (= x2 x3)))) (|fail_83[0:0]| x0))))
(assert (forall ((x2 Int)(x1 Int)(x0 Int)(var1891 Int)(var1893 Int)(var1894 Int)(var1892 Int)(var1890 Int)) (=> (and (|aux[0:9][0:0]| var1894 x2 x2 var1892 var1894 x1 var1890 0 true) (and (|assign[0:7][0:0][0:1][0:0]| x2 var1894 x1 x2 var1894 var1891 var1894 var1892) (and (|loop[0:3][0:1][0:0]| var1894 x1 x2 var1894 var1893) (and (|loop[0:2]| var1894 x1 x2) (and (= x0 0) (and (<= var1891 x1) (and (= var1891 (+ 1 var1893)) (and (<= 0 var1894) (= (+ 1 var1894) x1))))))))) (|aux_45[0:3]| x2 x1 x0))))
...
(assert (forall ((x1 Int)(x2 Int)(x3 Int)(x7 Int)(x4 Int)(x5 Int)(x6 Int)(x0 Int)(var1895 Int)(var1896 Int)) (=> (and (|assign[0:7][0:0][0:1][0:0]| x3 x4 x5 x3 x4 var1895 x1 x7) (and (|loop[0:3][0:1][0:0]| x4 x5 x3 x4 var1896) (and (|loop[0:2]| x4 x5 x3) (and (= x0 0) (and (<= var1895 x5) (and (= var1895 (+ 1 var1896)) (and (<= 0 x1) (and (<= 0 x4) (and (= x3 x2) (= x4 x1)))))))))) (|aux[0:8]| x1 x2 x3 x7 x4 x5 x6 x0))))
