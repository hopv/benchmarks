...
(assert (forall ((x1 Int)(x0 Int)(x2 Int)(var602 Int)(var601 Int)) (=> (and (|sum[0:1]| x1 x0) (and (|sum[0:2][0:0]| x1 var601 var602) (and (= x2 (+ x0 var602)) (and (>= x0 1) (= (+ 1 var601) x0))))) (|sum[0:2][0:0]| x1 x0 x2))))
...
(assert (forall ((x2 Int)(x1 Int)(x0 Int)(x3 Int)(var604 Int)(var603 Int)) (=> (and (|mult[0:2]| x2 x1 x0) (and (|mult[0:3][0:0]| x2 x1 var603 var604) (and (= x3 (+ x1 var604)) (and (>= x1 1) (and (>= x0 1) (= (+ 1 var603) x0)))))) (|mult[0:3][0:0]| x2 x1 x0 x3))))
