...
(assert
  (forall ( (|$alpha-15:set_flag_up_1089| Int) (|$alpha-16:s_up_x_1086| Int) (|$alpha-17:x_1036| Int) (|$knormal:21| Int) )
    (=>
      ( and (not (= |$alpha-17:x_1036| 0)) (|up_without_checking_1115$unknown:29| |$knormal:21| (+ |$alpha-17:x_1036| 1) |$alpha-17:x_1036| 1) )
      (|up_without_checking_1115$unknown:29| |$knormal:21| |$alpha-17:x_1036| |$alpha-16:s_up_x_1086| |$alpha-15:set_flag_up_1089|)
    )
  )
)
(assert
  (forall ( (|$alpha-15:set_flag_up_1089| Int) (|$alpha-16:s_up_x_1086| Int) )
    (=>
      ( and true )
      (|up_without_checking_1115$unknown:29| 1 0 |$alpha-16:s_up_x_1086| |$alpha-15:set_flag_up_1089|)
    )
  )
)
(check-sat)
