...
(assert
  (forall ( (|$alpha-3:set_flag_mc91_1050| Int) (|$alpha-4:s_mc91_n_1047| Int) (|$alpha-5:n_1031| Int) (|$knormal:15| Int) (|$knormal:9| Int) )
    (=>
      ( and (not (> |$alpha-5:n_1031| 100)) (|mc91_without_checking_1058$unknown:12| |$knormal:9| (+ |$alpha-5:n_1031| 11) |$alpha-5:n_1031| 1) (|mc91_without_checking_1058$unknown:12| |$knormal:15| |$knormal:9| |$alpha-5:n_1031| 1) )
      (|mc91_without_checking_1058$unknown:12| |$knormal:15| |$alpha-5:n_1031| |$alpha-4:s_mc91_n_1047| |$alpha-3:set_flag_mc91_1050|)
    )
  )
)
(assert
  (forall ( (|$alpha-3:set_flag_mc91_1050| Int) (|$alpha-4:s_mc91_n_1047| Int) (|$alpha-5:n_1031| Int) )
    (=>
      ...
      (|mc91_without_checking_1058$unknown:12| (- |$alpha-5:n_1031| 10) |$alpha-5:n_1031| |$alpha-4:s_mc91_n_1047| |$alpha-3:set_flag_mc91_1050|)
    )
  )
)
(check-sat)
