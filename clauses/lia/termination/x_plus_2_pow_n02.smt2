...
(assert
  (forall ( (|$V-reftype:52| Int) (|$V-reftype:54| Int) (|$V-reftype:56| Int) (|$alpha-15:set_flag_f_1181| Int) (|$alpha-16:s_f_n_1178| Int) (|$cond-alpha-rename:107| Int) (|$cond-alpha-rename:114| Int) (|$cond-alpha-rename:115| Int) )
    (=>
      ( and (= 1 1) (= 1 1) (= 0 (+ (* 0 |$cond-alpha-rename:107|) 0)) (= 0 (+ (* 0 |$cond-alpha-rename:107|) 0)) (not (= |$cond-alpha-rename:107| 0)) (not (= |$cond-alpha-rename:107| 0)) (not (= |$cond-alpha-rename:107| 0)) (|f_without_checking_1189$unknown:16| |$cond-alpha-rename:115| |$V-reftype:56| |$V-reftype:54| |$V-reftype:52| (- |$cond-alpha-rename:107| 1) |$cond-alpha-rename:107| 1) (|f_without_checking_1189$unknown:16| |$cond-alpha-rename:114| |$cond-alpha-rename:115| |$V-reftype:54| |$V-reftype:52| (- |$cond-alpha-rename:107| 1) |$cond-alpha-rename:107| 1) )
      (|f_without_checking_1189$unknown:16| |$cond-alpha-rename:114| |$V-reftype:56| |$V-reftype:54| |$V-reftype:52| |$cond-alpha-rename:107| |$alpha-16:s_f_n_1178| |$alpha-15:set_flag_f_1181|)
    )
  )
)
(assert
