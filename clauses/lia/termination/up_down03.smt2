...
(assert
  (forall ( (|$alpha-22:set_flag_down_1132| Int) (|$alpha-23:s_down_x_1129| Int) (|$alpha-24:x_1036| Int) (|$knormal:30| Int) )
    (=>
      ( and (not (= |$alpha-24:x_1036| 0)) (|up_1032$unknown:29| |$knormal:30| (+ |$alpha-24:x_1036| 1) |$alpha-23:s_down_x_1129| |$alpha-22:set_flag_down_1132|) )
      (|up_1032$unknown:29| |$knormal:30| |$alpha-24:x_1036| |$alpha-23:s_down_x_1129| |$alpha-22:set_flag_down_1132|)
    )
  )
)
(assert
