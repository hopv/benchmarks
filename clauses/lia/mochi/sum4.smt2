...
(assert
  (not (exists ( (|$knormal:6| Int) (|$knormal:5| Int) (|$alpha-2:n| Int) (|$knormal:7| Int) (|$knormal:9| Bool) )
    ( and (|sum$unknown:2| |$knormal:7| |$alpha-2:n|) (not |$knormal:9|) (= |$knormal:5| (* 4 |$alpha-2:n|)) (= |$knormal:6| (- |$knormal:5| 6)) (= |$knormal:9| (<= |$knormal:6| |$knormal:7|)) )
    )
  )
)
(assert
  (forall ( (|$knormal:6| Int) (|$knormal:5| Int) (|$alpha-2:n| Int) )
    (=>
      ( and (= |$knormal:5| (* 4 |$alpha-2:n|)) (= |$knormal:6| (- |$knormal:5| 6)) )
