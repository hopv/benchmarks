...
(assert
  (forall ( (|$knormal:2| Int) (|$alpha-1:x| Int) (|$knormal:1| Int) (|$V-reftype:15| Int) )
    (=>
      ( and (|f$unknown:1| |$alpha-1:x|) (|f$unknown:3| |$knormal:2| |$knormal:1| |$alpha-1:x|) (= |$V-reftype:15| |$knormal:2|) (= |$knormal:1| (+ |$alpha-1:x| 1)) )
...
(assert
  (forall ( (|$alpha-4:n| Int) (|$V-reftype:3| Int) (|$knormal:4| Bool) )
    (=>
      ( and (|f$unknown:2| |$V-reftype:3| |$alpha-4:n|) |$knormal:4| (= |$knormal:4| (>= |$alpha-4:n| 0)) )
...
(assert
  (forall ( (|$alpha-4:n| Int) (|h| Int) (|$V-reftype:10| Int) (|$knormal:4| Bool) )
    (=>
      ( and (|f$unknown:2| |h| |$alpha-4:n|) (|h$unknown:6| |$V-reftype:10| |h|) |$knormal:4| (= |$knormal:4| (>= |$alpha-4:n| 0)) )
...
(assert
  (forall ( (|$V-reftype:17| Int) (|$alpha-3:y| Int) (|$knormal:3| Bool) )
    (=>
      ( and (|h$unknown:5| |$alpha-3:y|) |$knormal:3| (= |$V-reftype:17| 1) (= |$knormal:3| (> |$alpha-3:y| 0)) )
...
(assert
  (not (exists ( (|$knormal:3| Bool) (|$alpha-3:y| Int) )
    ( and (|h$unknown:5| |$alpha-3:y|) (not |$knormal:3|) (= |$knormal:3| (> |$alpha-3:y| 0)) )
    )
  )
)
(assert
