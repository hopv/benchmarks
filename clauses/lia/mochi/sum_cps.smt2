...
(assert
  (forall ( (|$V-reftype:32| Int) (|$alpha-4:n| Int) (|$alpha-5:x| Int) (|$knormal:17| Int) )
    (=>
      ( and (= (not (= 0 |$knormal:17|)) (>= |$alpha-5:x| |$alpha-4:n|)) (= |$V-reftype:32| 1) (not (= 0 |$knormal:17|)) (|$innerFunc:2-f$unknown:7| |$alpha-5:x| |$alpha-4:n|) (|$innerFunc:2-f$unknown:6| |$alpha-4:n|) )
...
(assert
  (not (exists ( (|$alpha-4:n| Int) (|$alpha-5:x| Int) (|$knormal:17| Int) )
    ( and (= (not (= 0 |$knormal:17|)) (>= |$alpha-5:x| |$alpha-4:n|)) (not (not (= 0 |$knormal:17|))) (|$innerFunc:2-f$unknown:7| |$alpha-5:x| |$alpha-4:n|) (|$innerFunc:2-f$unknown:6| |$alpha-4:n|) )
    )
  )
)
(assert
