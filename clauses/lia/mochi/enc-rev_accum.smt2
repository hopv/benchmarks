...
(assert
  (forall ( (|$V-reftype:13| Int) (|$knormal:2| Int) (|$knormal:6| Int) (|$alpha-2:m| Int) (|$alpha-1:n| Int) (|$knormal:4| Int) (|$knormal:1| Bool) )
    (=>
      ( and (|rev$unknown:1| |$alpha-1:n|) (|rev$unknown:2| |$alpha-2:m| |$alpha-1:n|) (|rev$unknown:3| |$knormal:6| |$knormal:4| |$knormal:2|) (not |$knormal:1|) (= |$V-reftype:13| |$knormal:6|) (= |$knormal:1| (= |$alpha-1:n| 0)) (= |$knormal:2| (- |$alpha-1:n| 1)) (= |$knormal:4| (+ |$alpha-2:m| 1)) )
...
(assert
  (forall ( (|$V-reftype:10| Int) (|$alpha-1:n| Int) (|$alpha-2:m| Int) (|$knormal:1| Bool) )
    (=>
      ( and (|rev$unknown:1| |$alpha-1:n|) (|rev$unknown:2| |$alpha-2:m| |$alpha-1:n|) |$knormal:1| (= |$V-reftype:10| |$alpha-2:m|) (= |$knormal:1| (= |$alpha-1:n| 0)) )
...
(assert
  (forall ( (|$knormal:4| Int) (|$knormal:2| Int) (|$alpha-1:n| Int) (|$alpha-2:m| Int) (|$knormal:1| Bool) )
    (=>
      ( and (|rev$unknown:1| |$alpha-1:n|) (|rev$unknown:2| |$alpha-2:m| |$alpha-1:n|) (not |$knormal:1|) (= |$knormal:1| (= |$alpha-1:n| 0)) (= |$knormal:2| (- |$alpha-1:n| 1)) (= |$knormal:4| (+ |$alpha-2:m| 1)) )
...
(assert
  (not (exists ( (|$knormal:12| Bool) (|$knormal:8| Int) (|$knormal:10| Int) (|$alpha-3:n| Int) )
    ( and (|rev$unknown:3| |$knormal:10| |$knormal:8| |$alpha-3:n|) (not |$knormal:12|) (= |$knormal:12| (>= |$knormal:10| |$alpha-3:n|)) (= |$knormal:8| 0) )
    )
  )
)
(check-sat)
