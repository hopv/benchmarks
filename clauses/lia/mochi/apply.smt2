...
(assert
  (forall ( (|$V-reftype:21| Int) (|$alpha-3:y| Int) (|$alpha-4:z| Int) (|$knormal:2| Bool) )
    (=>
      ( and (= |$knormal:2| (= |$alpha-3:y| |$alpha-4:z|)) (= |$V-reftype:21| 1) |$knormal:2| (|g$unknown:6| |$alpha-4:z| |$alpha-3:y|) (|g$unknown:5| |$alpha-3:y|) )
...
(assert
  (not (exists ( (|$alpha-3:y| Int) (|$alpha-4:z| Int) (|$knormal:2| Bool) )
    ( and (= |$knormal:2| (= |$alpha-3:y| |$alpha-4:z|)) (not |$knormal:2|) (|g$unknown:6| |$alpha-4:z| |$alpha-3:y|) (|g$unknown:5| |$alpha-3:y|) )
    )
  )
)
(check-sat)
