...
(assert
  (forall ( (|$V-reftype:30| Int) (|$alpha-6:n| Int) (|$alpha-7:n| Int) (|$knormal:15| Int) (|$knormal:16| Int) )
    (=>
      ( and (= (not (= 0 |$knormal:15|)) (= |$alpha-7:n| 0)) (= |$V-reftype:30| |$knormal:16|) (not (not (= 0 |$knormal:15|))) (|exn$unknown:5| |$knormal:16| |$alpha-7:n|) (|$innerFunc:1-exn$unknown:2| |$alpha-7:n| |$alpha-6:n|) (|$innerFunc:1-exn$unknown:1| |$alpha-6:n|) )
...
(assert
  (forall ( (|$V-reftype:29| Int) (|$alpha-6:n| Int) (|$alpha-7:n| Int) (|$knormal:15| Int) )
    (=>
      ( and (= (not (= 0 |$knormal:15|)) (= |$alpha-7:n| 0)) (= |$V-reftype:29| 1) (not (= 0 |$knormal:15|)) (|$innerFunc:1-exn$unknown:2| |$alpha-7:n| |$alpha-6:n|) (|$innerFunc:1-exn$unknown:1| |$alpha-6:n|) )
...
(assert
  (forall ( (|$alpha-6:n| Int) (|$alpha-7:n| Int) (|$knormal:15| Int) )
    (=>
      ( and (= (not (= 0 |$knormal:15|)) (= |$alpha-7:n| 0)) (not (not (= 0 |$knormal:15|))) (|$innerFunc:1-exn$unknown:2| |$alpha-7:n| |$alpha-6:n|) (|$innerFunc:1-exn$unknown:1| |$alpha-6:n|) )
