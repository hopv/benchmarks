...
(assert
  (not (exists ( (|$knormal:18| Bool) (|$knormal:17| Bool) (|$knormal:19| Bool) (|$alpha-6:b| Int) (|$knormal:24| Int) (|$alpha-4:n| Int) (|$alpha-5:a| Int) (|$knormal:26| Bool) )
    ( and (|gib$unknown:4| |$knormal:24| |$alpha-4:n| |$alpha-6:b| |$alpha-5:a|) |$knormal:19| (not |$knormal:26|) (= |$knormal:17| (>= |$alpha-5:a| 0)) (= |$knormal:18| (>= |$alpha-6:b| 0)) (= |$knormal:19| (and |$knormal:17| |$knormal:18|)) (= |$knormal:26| (>= |$knormal:24| 0)) )
    )
  )
)
(assert
  (forall ( (|$alpha-6:b| Int) (|$alpha-5:a| Int) (|$knormal:19| Bool) (|$knormal:17| Bool) (|$knormal:18| Bool) )
    (=>
      ( and |$knormal:19| (= |$knormal:17| (>= |$alpha-5:a| 0)) (= |$knormal:18| (>= |$alpha-6:b| 0)) (= |$knormal:19| (and |$knormal:17| |$knormal:18|)) )
