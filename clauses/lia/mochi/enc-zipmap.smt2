...
(assert
  (forall ( (|$V-reftype:20| Int) (|$knormal:1| Bool) (|$knormal:5| Int) (|$alpha-1:x| Int) (|$alpha-2:y| Int) (|$knormal:7| Int) (|$knormal:3| Int) (|$knormal:2| Bool) )
    (=>
      ( and (= |$knormal:5| (- |$alpha-2:y| 1)) (= |$knormal:3| (- |$alpha-1:x| 1)) (= |$knormal:2| (= |$alpha-2:y| 0)) (= |$knormal:1| (= |$alpha-1:x| 0)) (= |$V-reftype:20| (+ 1 |$knormal:7|)) (not |$knormal:2|) (not |$knormal:1|) (|zip$unknown:5| |$knormal:7| |$knormal:5| |$knormal:3|) (|zip$unknown:4| |$alpha-2:y| |$alpha-1:x|) (|zip$unknown:3| |$alpha-1:x|) )
...
(assert
  (forall ( (|$V-reftype:14| Int) (|$knormal:1| Bool) (|$alpha-2:y| Int) (|$alpha-1:x| Int) (|$knormal:9| Bool) )
    (=>
      ( and (= |$knormal:9| (= |$alpha-2:y| 0)) (= |$knormal:1| (= |$alpha-1:x| 0)) (= |$V-reftype:14| |$alpha-1:x|) |$knormal:9| |$knormal:1| (|zip$unknown:4| |$alpha-2:y| |$alpha-1:x|) (|zip$unknown:3| |$alpha-1:x|) )
...
(assert
  (not (exists ( (|$knormal:9| Bool) (|$alpha-1:x| Int) (|$alpha-2:y| Int) (|$knormal:1| Bool) )
    ( and (= |$knormal:9| (= |$alpha-2:y| 0)) (= |$knormal:1| (= |$alpha-1:x| 0)) (not |$knormal:9|) |$knormal:1| (|zip$unknown:4| |$alpha-2:y| |$alpha-1:x|) (|zip$unknown:3| |$alpha-1:x|) )
    )
  )
)
(assert
  (not (exists ( (|$knormal:1| Bool) (|$alpha-1:x| Int) (|$alpha-2:y| Int) (|$knormal:2| Bool) )
    ( and (= |$knormal:2| (= |$alpha-2:y| 0)) (= |$knormal:1| (= |$alpha-1:x| 0)) (not |$knormal:1|) |$knormal:2| (|zip$unknown:4| |$alpha-2:y| |$alpha-1:x|) (|zip$unknown:3| |$alpha-1:x|) )
    )
  )
)
(assert
  (forall ( (|$knormal:5| Int) (|$knormal:3| Int) (|$knormal:1| Bool) (|$alpha-2:y| Int) (|$alpha-1:x| Int) (|$knormal:2| Bool) )
    (=>
      ( and (= |$knormal:5| (- |$alpha-2:y| 1)) (= |$knormal:3| (- |$alpha-1:x| 1)) (= |$knormal:2| (= |$alpha-2:y| 0)) (= |$knormal:1| (= |$alpha-1:x| 0)) (not |$knormal:2|) (not |$knormal:1|) (|zip$unknown:4| |$alpha-2:y| |$alpha-1:x|) (|zip$unknown:3| |$alpha-1:x|) )
