...
(assert
  (forall ( (|$V-reftype:24| Int) (|$alpha-3:x| Int) (|$knormal:10| Int) (|$knormal:11| Int) (|$knormal:12| Int) )
    (=>
      ( and (= |$knormal:11| (- |$alpha-3:x| 1)) (= (not (= 0 |$knormal:10|)) (= |$alpha-3:x| 0)) (= |$V-reftype:24| (+ 1 |$knormal:12|)) (not (not (= 0 |$knormal:10|))) (|map$unknown:2| |$knormal:12| |$knormal:11|) (|map$unknown:1| |$alpha-3:x|) )
...
(assert
  (forall ( (|$V-reftype:22| Int) (|$alpha-3:x| Int) (|$knormal:10| Int) )
    (=>
      ( and (= (not (= 0 |$knormal:10|)) (= |$alpha-3:x| 0)) (= |$V-reftype:22| |$alpha-3:x|) (not (= 0 |$knormal:10|)) (|map$unknown:1| |$alpha-3:x|) )
...
(assert
  (forall ( (|$alpha-3:x| Int) (|$knormal:10| Int) (|$knormal:11| Int) )
    (=>
      ( and (= |$knormal:11| (- |$alpha-3:x| 1)) (= (not (= 0 |$knormal:10|)) (= |$alpha-3:x| 0)) (not (not (= 0 |$knormal:10|))) (|map$unknown:1| |$alpha-3:x|) )
...
(assert
  (forall ( (|$V-reftype:20| Int) (|$alpha-1:x| Int) (|$alpha-2:y| Int) (|$knormal:1| Int) (|$knormal:2| Int) (|$knormal:3| Int) (|$knormal:5| Int) (|$knormal:7| Int) )
    (=>
      ( and (= |$knormal:5| (- |$alpha-2:y| 1)) (= |$knormal:3| (- |$alpha-1:x| 1)) (= (not (= 0 |$knormal:2|)) (= |$alpha-2:y| 0)) (= (not (= 0 |$knormal:1|)) (= |$alpha-1:x| 0)) (= |$V-reftype:20| (+ 1 |$knormal:7|)) (not (not (= 0 |$knormal:2|))) (not (not (= 0 |$knormal:1|))) (|zip$unknown:5| |$knormal:7| |$knormal:5| |$knormal:3|) (|zip$unknown:4| |$alpha-2:y| |$alpha-1:x|) (|zip$unknown:3| |$alpha-1:x|) )
...
(assert
  (forall ( (|$V-reftype:14| Int) (|$alpha-1:x| Int) (|$alpha-2:y| Int) (|$knormal:1| Int) (|$knormal:9| Int) )
    (=>
      ( and (= (not (= 0 |$knormal:9|)) (= |$alpha-2:y| 0)) (= (not (= 0 |$knormal:1|)) (= |$alpha-1:x| 0)) (= |$V-reftype:14| |$alpha-1:x|) (not (= 0 |$knormal:9|)) (not (= 0 |$knormal:1|)) (|zip$unknown:4| |$alpha-2:y| |$alpha-1:x|) (|zip$unknown:3| |$alpha-1:x|) )
...
(assert
  (not (exists ( (|$alpha-1:x| Int) (|$alpha-2:y| Int) (|$knormal:1| Int) (|$knormal:9| Int) )
    ( and (= (not (= 0 |$knormal:9|)) (= |$alpha-2:y| 0)) (= (not (= 0 |$knormal:1|)) (= |$alpha-1:x| 0)) (not (not (= 0 |$knormal:9|))) (not (= 0 |$knormal:1|)) (|zip$unknown:4| |$alpha-2:y| |$alpha-1:x|) (|zip$unknown:3| |$alpha-1:x|) )
    )
  )
)
(assert
  (not (exists ( (|$alpha-1:x| Int) (|$alpha-2:y| Int) (|$knormal:1| Int) (|$knormal:2| Int) )
    ( and (= (not (= 0 |$knormal:2|)) (= |$alpha-2:y| 0)) (= (not (= 0 |$knormal:1|)) (= |$alpha-1:x| 0)) (not (not (= 0 |$knormal:1|))) (not (= 0 |$knormal:2|)) (|zip$unknown:4| |$alpha-2:y| |$alpha-1:x|) (|zip$unknown:3| |$alpha-1:x|) )
    )
  )
)
(assert
  (forall ( (|$alpha-1:x| Int) (|$alpha-2:y| Int) (|$knormal:1| Int) (|$knormal:2| Int) (|$knormal:3| Int) (|$knormal:5| Int) )
    (=>
      ( and (= |$knormal:5| (- |$alpha-2:y| 1)) (= |$knormal:3| (- |$alpha-1:x| 1)) (= (not (= 0 |$knormal:2|)) (= |$alpha-2:y| 0)) (= (not (= 0 |$knormal:1|)) (= |$alpha-1:x| 0)) (not (not (= 0 |$knormal:2|))) (not (not (= 0 |$knormal:1|))) (|zip$unknown:4| |$alpha-2:y| |$alpha-1:x|) (|zip$unknown:3| |$alpha-1:x|) )
