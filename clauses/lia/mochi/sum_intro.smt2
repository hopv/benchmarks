...
(assert
  (forall ( (|$alpha-1:x| Int) (|$alpha-2:y| Int) (|$V-reftype:12| Int) )
    (=>
      ( and (|add$unknown:1| |$alpha-1:x|) (|add$unknown:2| |$alpha-2:y| |$alpha-1:x|) (= |$V-reftype:12| (+ |$alpha-1:x| |$alpha-2:y|)) )
...
(assert
  (forall ( (|$knormal:1| Bool) (|$alpha-3:n| Int) (|$knormal:7| Int) (|$knormal:3| Int) (|$knormal:2| Int) (|$V-reftype:16| Int) )
    (=>
      ( and (|add$unknown:3| |$knormal:7| |$knormal:3| |$alpha-3:n|) (|sum$unknown:4| |$alpha-3:n|) (|sum$unknown:5| |$knormal:3| |$knormal:2|) (not |$knormal:1|) (= |$V-reftype:16| |$knormal:7|) (= |$knormal:1| (<= |$alpha-3:n| 0)) (= |$knormal:2| (- |$alpha-3:n| 1)) )
...
(assert
  (forall ( (|$knormal:2| Int) (|$alpha-3:n| Int) (|$knormal:3| Int) (|$knormal:1| Bool) )
    (=>
      ( and (|sum$unknown:4| |$alpha-3:n|) (|sum$unknown:5| |$knormal:3| |$knormal:2|) (not |$knormal:1|) (= |$knormal:1| (<= |$alpha-3:n| 0)) (= |$knormal:2| (- |$alpha-3:n| 1)) )
...
(assert
  (forall ( (|$V-reftype:14| Int) (|$alpha-3:n| Int) (|$knormal:1| Bool) )
    (=>
      ( and (|sum$unknown:4| |$alpha-3:n|) |$knormal:1| (= |$V-reftype:14| 0) (= |$knormal:1| (<= |$alpha-3:n| 0)) )
...
(assert
  (forall ( (|$knormal:2| Int) (|$alpha-3:n| Int) (|$knormal:1| Bool) )
    (=>
      ( and (|sum$unknown:4| |$alpha-3:n|) (not |$knormal:1|) (= |$knormal:1| (<= |$alpha-3:n| 0)) (= |$knormal:2| (- |$alpha-3:n| 1)) )
...
(assert
  (not (exists ( (|$alpha-4:n| Int) (|$knormal:8| Int) (|$knormal:10| Bool) )
    ( and (|sum$unknown:5| |$knormal:8| |$alpha-4:n|) (not |$knormal:10|) (= |$knormal:10| (<= |$alpha-4:n| |$knormal:8|)) )
    )
  )
)
(check-sat)
