...
(assert
  (forall ( (|$V-reftype:19| Int) (|$alpha-3:z| Int) (|$alpha-4:y| Int) (|$knormal:3| Int) )
    (=>
      ( and (= (not (= 0 |$knormal:3|)) (> |$alpha-4:y| |$alpha-3:z|)) (= |$V-reftype:19| 1) (not (= 0 |$knormal:3|)) (|h$unknown:6| |$alpha-4:y| |$alpha-3:z|) (|h$unknown:5| |$alpha-3:z|) )
...
(assert
  (not (exists ( (|$alpha-3:z| Int) (|$alpha-4:y| Int) (|$knormal:3| Int) )
    ( and (= (not (= 0 |$knormal:3|)) (> |$alpha-4:y| |$alpha-3:z|)) (not (not (= 0 |$knormal:3|))) (|h$unknown:6| |$alpha-4:y| |$alpha-3:z|) (|h$unknown:5| |$alpha-3:z|) )
    )
  )
)
(assert
