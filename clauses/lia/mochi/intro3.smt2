...
(assert
  (forall ( (|$knormal:4| Bool) (|$V-reftype:3| Int) (|$alpha-5:n| Int) )
    (=>
      ( and (= |$knormal:4| (>= |$alpha-5:n| 0)) |$knormal:4| (|f$unknown:2| |$V-reftype:3| |$alpha-5:n|) )
...
(assert
  (forall ( (|$V-reftype:12| Int) (|$knormal:5| Int) (|$alpha-5:n| Int) (|$knormal:4| Bool) )
    (=>
      ( and (= |$knormal:4| (>= |$alpha-5:n| 0)) |$knormal:4| (|h$unknown:7| |$V-reftype:12| |$knormal:5| |$alpha-5:n|) (|f$unknown:2| |$knormal:5| |$alpha-5:n|) )
...
(assert
  (forall ( (|$V-reftype:19| Int) (|$alpha-3:z| Int) (|$alpha-4:y| Int) (|$knormal:3| Bool) )
    (=>
      ( and (= |$knormal:3| (> |$alpha-4:y| |$alpha-3:z|)) (= |$V-reftype:19| 1) |$knormal:3| (|h$unknown:6| |$alpha-4:y| |$alpha-3:z|) (|h$unknown:5| |$alpha-3:z|) )
...
(assert
  (not (exists ( (|$alpha-3:z| Int) (|$alpha-4:y| Int) (|$knormal:3| Bool) )
    ( and (= |$knormal:3| (> |$alpha-4:y| |$alpha-3:z|)) (not |$knormal:3|) (|h$unknown:6| |$alpha-4:y| |$alpha-3:z|) (|h$unknown:5| |$alpha-3:z|) )
    )
  )
)
(assert
  (forall ( (|$knormal:4| Bool) (|$alpha-5:n| Int) )
    (=>
      ( and (= |$knormal:4| (>= |$alpha-5:n| 0)) |$knormal:4| )
