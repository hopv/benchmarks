...
(assert
  (forall ( (|$V-reftype:17| Int) (|$alpha-1:x| Int) (|$alpha-2:y| Int) (|$knormal:1| Int) (|$knormal:2| Int) (|$knormal:5| Int) )
    (=>
      ( and (= |$knormal:2| (- |$alpha-1:x| 1)) (= (not (= 0 |$knormal:1|)) (= |$alpha-1:x| 0)) (= |$V-reftype:17| (+ 1 |$knormal:5|)) (not (not (= 0 |$knormal:1|))) (|append$unknown:3| |$knormal:5| |$alpha-2:y| |$knormal:2|) (|append$unknown:2| |$alpha-2:y| |$alpha-1:x|) (|append$unknown:1| |$alpha-1:x|) )
...
(assert
  (forall ( (|$V-reftype:15| Int) (|$alpha-1:x| Int) (|$alpha-2:y| Int) (|$knormal:1| Int) )
    (=>
      ( and (= (not (= 0 |$knormal:1|)) (= |$alpha-1:x| 0)) (= |$V-reftype:15| |$alpha-2:y|) (not (= 0 |$knormal:1|)) (|append$unknown:2| |$alpha-2:y| |$alpha-1:x|) (|append$unknown:1| |$alpha-1:x|) )
      (|append$unknown:3| |$V-reftype:15| |$alpha-2:y| |$alpha-1:x|)
    )
  )
)
(assert
  (forall ( (|$alpha-1:x| Int) (|$alpha-2:y| Int) (|$knormal:1| Int) (|$knormal:2| Int) )
    (=>
      ( and (= |$knormal:2| (- |$alpha-1:x| 1)) (= (not (= 0 |$knormal:1|)) (= |$alpha-1:x| 0)) (not (not (= 0 |$knormal:1|))) (|append$unknown:2| |$alpha-2:y| |$alpha-1:x|) (|append$unknown:1| |$alpha-1:x|) )
...
(assert
  (forall ( (|$V-reftype:22| Int) (|$alpha-3:n| Int) (|$knormal:12| Int) (|$knormal:14| Int) (|$knormal:7| Int) (|$knormal:8| Int) (|$knormal:9| Int) )
    (=>
      ( and (= |$knormal:8| (- |$alpha-3:n| 1)) (= (not (= 0 |$knormal:7|)) (= |$alpha-3:n| 0)) (= |$knormal:12| 1) (= |$V-reftype:22| |$knormal:14|) (not (not (= 0 |$knormal:7|))) (|rev$unknown:5| |$knormal:9| |$knormal:8|) (|rev$unknown:4| |$alpha-3:n|) (|append$unknown:3| |$knormal:14| |$knormal:12| |$knormal:9|) )
...
(assert
  (forall ( (|$alpha-3:n| Int) (|$knormal:12| Int) (|$knormal:7| Int) (|$knormal:8| Int) (|$knormal:9| Int) )
    (=>
      ( and (= |$knormal:8| (- |$alpha-3:n| 1)) (= (not (= 0 |$knormal:7|)) (= |$alpha-3:n| 0)) (= |$knormal:12| 1) (not (not (= 0 |$knormal:7|))) (|rev$unknown:5| |$knormal:9| |$knormal:8|) (|rev$unknown:4| |$alpha-3:n|) )
...
(assert
  (forall ( (|$V-reftype:19| Int) (|$alpha-3:n| Int) (|$knormal:7| Int) )
    (=>
      ( and (= (not (= 0 |$knormal:7|)) (= |$alpha-3:n| 0)) (= |$V-reftype:19| 0) (not (= 0 |$knormal:7|)) (|rev$unknown:4| |$alpha-3:n|) )
...
(assert
  (forall ( (|$alpha-3:n| Int) (|$knormal:12| Int) (|$knormal:7| Int) (|$knormal:8| Int) )
    (=>
      ( and (= |$knormal:8| (- |$alpha-3:n| 1)) (= (not (= 0 |$knormal:7|)) (= |$alpha-3:n| 0)) (= |$knormal:12| 1) (not (not (= 0 |$knormal:7|))) (|rev$unknown:4| |$alpha-3:n|) )
...
(assert
  (forall ( (|$alpha-4:n| Int) (|$alpha-5:m| Int) (|$alpha-6:$$tmp::1| Int) (|$knormal:21| Int) (|$knormal:23| Int) )
    (=>
      ( and (= (not (= 0 |$knormal:23|)) (= |$knormal:21| |$alpha-4:n|)) (= |$alpha-6:$$tmp::1| 1) (not (= 0 |$knormal:23|)) (|rev$unknown:5| |$knormal:21| |$alpha-4:n|) )
