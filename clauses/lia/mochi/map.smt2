...
(assert
  (forall ( (|$V-reftype:8| Int) (|$alpha-1:x| Int) (|$knormal:1| Bool) )
    (=>
      ( and (= |$knormal:1| (= |$alpha-1:x| 0)) (= |$V-reftype:8| 0) |$knormal:1| (|map$unknown:1| |$alpha-1:x|) )
...
(assert
  (not (exists ( (|$alpha-2:n| Int) (|$knormal:5| Int) (|$knormal:7| Bool) )
    ( and (= |$knormal:7| (= |$knormal:5| |$alpha-2:n|)) (not |$knormal:7|) (|map$unknown:2| |$knormal:5| |$alpha-2:n|) )
    )
  )
)
(check-sat)
