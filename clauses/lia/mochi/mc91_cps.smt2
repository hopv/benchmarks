...
(assert
  (forall ( (|$V-reftype:33| Int) (|$alpha-4:n| Int) (|$alpha-5:r| Int) (|$knormal:17| Int) (|$knormal:18| Int) )
    (=>
      ( and (= (not (= 0 |$knormal:18|)) (= |$alpha-5:r| 91)) (= (not (= 0 |$knormal:17|)) (<= |$alpha-4:n| 101)) (= |$V-reftype:33| 1) (not (= 0 |$knormal:18|)) (not (= 0 |$knormal:17|)) (|$innerFunc:2-k$unknown:7| |$alpha-5:r| |$alpha-4:n|) (|$innerFunc:2-k$unknown:6| |$alpha-4:n|) )
...
(assert
  (not (exists ( (|$alpha-4:n| Int) (|$alpha-5:r| Int) (|$knormal:17| Int) (|$knormal:18| Int) )
    ( and (= (not (= 0 |$knormal:18|)) (= |$alpha-5:r| 91)) (= (not (= 0 |$knormal:17|)) (<= |$alpha-4:n| 101)) (not (not (= 0 |$knormal:18|))) (not (= 0 |$knormal:17|)) (|$innerFunc:2-k$unknown:7| |$alpha-5:r| |$alpha-4:n|) (|$innerFunc:2-k$unknown:6| |$alpha-4:n|) )
    )
  )
)
(assert
  (forall ( (|$V-reftype:34| Int) (|$alpha-4:n| Int) (|$alpha-5:r| Int) (|$knormal:17| Int) )
    (=>
      ( and (= (not (= 0 |$knormal:17|)) (<= |$alpha-4:n| 101)) (= |$V-reftype:34| 1) (not (not (= 0 |$knormal:17|))) (|$innerFunc:2-k$unknown:7| |$alpha-5:r| |$alpha-4:n|) (|$innerFunc:2-k$unknown:6| |$alpha-4:n|) )
