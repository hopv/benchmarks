...
(assert
  (forall ( (|$alpha-15:m| Int) (|$knormal:34| Bool) (|$knormal:33| Bool) (|$V-reftype:40| Int) (|$knormal:44| Int) (|$alpha-14:n| Int) (|$knormal:35| Bool) (|$alpha-13:i| Int) )
    (=>
      ( and (= |$knormal:35| (and |$knormal:33| |$knormal:34|)) (= |$knormal:34| (<= |$alpha-14:n| |$alpha-15:m|)) (= |$knormal:33| (= |$alpha-13:i| 0)) |$knormal:35| (|make_array$unknown:18| |$V-reftype:40| |$knormal:44| |$alpha-14:n|) (|bcopy_aux$unknown:10| |$knormal:44| |$alpha-14:n|) )
...
(assert
  (forall ( (|$alpha-13:i| Int) (|$knormal:35| Bool) (|$V-reftype:22| Int) (|$alpha-14:n| Int) (|$knormal:33| Bool) (|$knormal:34| Bool) (|$alpha-15:m| Int) )
    (=>
      ( and (= |$knormal:35| (and |$knormal:33| |$knormal:34|)) (= |$knormal:34| (<= |$alpha-14:n| |$alpha-15:m|)) (= |$knormal:33| (= |$alpha-13:i| 0)) |$knormal:35| (|bcopy_aux$unknown:12| |$V-reftype:22| |$alpha-14:n|) )
      (|make_array$unknown:17| |$V-reftype:22| |$alpha-15:m|)
    )
  )
)
(assert
  (forall ( (|$knormal:34| Bool) (|$knormal:33| Bool) (|$alpha-15:m| Int) (|$V-reftype:40| Int) (|$knormal:43| Int) (|$alpha-14:n| Int) (|$knormal:35| Bool) (|$alpha-13:i| Int) )
    (=>
      ( and (= |$knormal:35| (and |$knormal:33| |$knormal:34|)) (= |$knormal:34| (<= |$alpha-14:n| |$alpha-15:m|)) (= |$knormal:33| (= |$alpha-13:i| 0)) |$knormal:35| (|make_array$unknown:18| |$V-reftype:40| |$knormal:43| |$alpha-15:m|) (|bcopy_aux$unknown:12| |$knormal:43| |$alpha-14:n|) )
...
(assert
  (forall ( (|$alpha-15:m| Int) (|$knormal:34| Bool) (|$knormal:33| Bool) (|$knormal:35| Bool) (|$alpha-13:i| Int) (|$alpha-14:n| Int) )
    (=>
      ( and (= |$knormal:35| (and |$knormal:33| |$knormal:34|)) (= |$knormal:34| (<= |$alpha-14:n| |$alpha-15:m|)) (= |$knormal:33| (= |$alpha-13:i| 0)) |$knormal:35| )
