...
(assert
  (forall ( (|$V-reftype:28| Int) (|$alpha-4:x| Int) (|$knormal:11| Int) (|$knormal:12| Int) (|$knormal:13| Int) )
    (=>
      ( and (= |$knormal:12| (- |$alpha-4:x| 1)) (= (not (= 0 |$knormal:11|)) (= |$alpha-4:x| 0)) (= |$V-reftype:28| (+ 1 |$knormal:13|)) (not (not (= 0 |$knormal:11|))) (|map$unknown:4| |$knormal:13| |$knormal:12|) (|map$unknown:3| |$alpha-4:x|) )
...
(assert
  (forall ( (|$V-reftype:26| Int) (|$alpha-4:x| Int) (|$knormal:11| Int) )
    (=>
      ( and (= (not (= 0 |$knormal:11|)) (= |$alpha-4:x| 0)) (= |$V-reftype:26| |$alpha-4:x|) (not (= 0 |$knormal:11|)) (|map$unknown:3| |$alpha-4:x|) )
...
(assert
  (forall ( (|$alpha-4:x| Int) (|$knormal:11| Int) (|$knormal:12| Int) )
    (=>
      ( and (= |$knormal:12| (- |$alpha-4:x| 1)) (= (not (= 0 |$knormal:11|)) (= |$alpha-4:x| 0)) (not (not (= 0 |$knormal:11|))) (|map$unknown:3| |$alpha-4:x|) )
...
(assert
  (forall ( (|$V-reftype:24| Int) (|$alpha-2:x| Int) (|$alpha-3:y| Int) (|$knormal:2| Int) (|$knormal:3| Int) (|$knormal:4| Int) (|$knormal:6| Int) (|$knormal:8| Int) )
    (=>
      ( and (= |$knormal:6| (- |$alpha-3:y| 1)) (= |$knormal:4| (- |$alpha-2:x| 1)) (= (not (= 0 |$knormal:3|)) (= |$alpha-3:y| 0)) (= (not (= 0 |$knormal:2|)) (= |$alpha-2:x| 0)) (= |$V-reftype:24| (+ 1 |$knormal:8|)) (not (not (= 0 |$knormal:3|))) (not (not (= 0 |$knormal:2|))) (|zip$unknown:7| |$knormal:8| |$knormal:6| |$knormal:4|) (|zip$unknown:6| |$alpha-3:y| |$alpha-2:x|) (|zip$unknown:5| |$alpha-2:x|) )
...
(assert
  (forall ( (|$V-reftype:18| Int) (|$alpha-2:x| Int) (|$alpha-3:y| Int) (|$knormal:10| Int) (|$knormal:2| Int) )
    (=>
      ( and (= (not (= 0 |$knormal:2|)) (= |$alpha-2:x| 0)) (= (not (= 0 |$knormal:10|)) (= |$alpha-3:y| 0)) (= |$V-reftype:18| |$alpha-2:x|) (not (= 0 |$knormal:2|)) (not (= 0 |$knormal:10|)) (|zip$unknown:6| |$alpha-3:y| |$alpha-2:x|) (|zip$unknown:5| |$alpha-2:x|) )
...
(assert
  (not (exists ( (|$alpha-2:x| Int) (|$alpha-3:y| Int) (|$knormal:10| Int) (|$knormal:2| Int) )
    ( and (= (not (= 0 |$knormal:2|)) (= |$alpha-2:x| 0)) (= (not (= 0 |$knormal:10|)) (= |$alpha-3:y| 0)) (not (not (= 0 |$knormal:10|))) (not (= 0 |$knormal:2|)) (|zip$unknown:6| |$alpha-3:y| |$alpha-2:x|) (|zip$unknown:5| |$alpha-2:x|) )
    )
  )
)
(assert
  (not (exists ( (|$alpha-2:x| Int) (|$alpha-3:y| Int) (|$knormal:2| Int) (|$knormal:3| Int) )
    ( and (= (not (= 0 |$knormal:3|)) (= |$alpha-3:y| 0)) (= (not (= 0 |$knormal:2|)) (= |$alpha-2:x| 0)) (not (not (= 0 |$knormal:2|))) (not (= 0 |$knormal:3|)) (|zip$unknown:6| |$alpha-3:y| |$alpha-2:x|) (|zip$unknown:5| |$alpha-2:x|) )
    )
  )
)
(assert
