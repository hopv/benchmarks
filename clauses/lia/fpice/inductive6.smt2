...
(assert
  (forall ( (|$knormal:4| Int) (|decr| Int) (|$V-reftype:3| Int) )
    (=>
      ( and (|decr$unknown:2| |$V-reftype:3| |decr|) (|f$unknown:3| |decr|) (= |$knormal:4| 3) )
...
(assert
  (forall ( (|$V-reftype:4| Int) (|$knormal:4| Int) )
    (=>
      ( and (|f$unknown:3| |$V-reftype:4|) (= |$knormal:4| 3) )
...
(assert
  (not (exists ( (|$knormal:4| Int) (|$knormal:6| Int) (|$knormal:8| Bool) )
    ( and (|f$unknown:6| |$knormal:6| |$knormal:4|) (not |$knormal:8|) (= |$knormal:4| 3) (= |$knormal:8| (> |$knormal:6| 0)) )
    )
  )
)
(check-sat)
