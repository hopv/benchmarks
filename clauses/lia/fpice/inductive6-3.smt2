...
(assert
  (forall ( (|$V-reftype:3| Int) (|$alpha-4:n| Int) (|$knormal:3| Int) (|$knormal:4| Int) (|$knormal:5| Int) (|decr| Int) )
    (=>
      ( and (= (not (= 0 |$knormal:5|)) (or (not (= 0 |$knormal:3|)) (not (= 0 |$knormal:4|)))) (= (not (= 0 |$knormal:4|)) (<= |$alpha-4:n| 0)) (= (not (= 0 |$knormal:3|)) (>= |$alpha-4:n| 3)) (not (= 0 |$knormal:5|)) (|f$unknown:3| |decr|) (|decr$unknown:2| |$V-reftype:3| |decr|) )
      (|f$unknown:4| |$V-reftype:3| |decr|)
    )
  )
)
(assert
  (forall ( (|$V-reftype:4| Int) (|$alpha-4:n| Int) (|$knormal:3| Int) (|$knormal:4| Int) (|$knormal:5| Int) )
    (=>
      ( and (= (not (= 0 |$knormal:5|)) (or (not (= 0 |$knormal:3|)) (not (= 0 |$knormal:4|)))) (= (not (= 0 |$knormal:4|)) (<= |$alpha-4:n| 0)) (= (not (= 0 |$knormal:3|)) (>= |$alpha-4:n| 3)) (not (= 0 |$knormal:5|)) (|f$unknown:3| |$V-reftype:4|) )
...
(assert
  (forall ( (|$V-reftype:15| Int) (|$alpha-2:x| Int) (|$knormal:1| Int) (|$knormal:2| Int) )
    (=>
      ( and (= (not (= 0 |$knormal:1|)) (> |$alpha-2:x| 0)) (= |$V-reftype:15| |$knormal:2|) (not (= 0 |$knormal:1|)) (|f$unknown:5| |$alpha-2:x|) (|f$unknown:4| |$knormal:2| |$alpha-2:x|) )
...
(assert
  (forall ( (|$alpha-2:x| Int) (|$knormal:1| Int) )
    (=>
      ( and (= (not (= 0 |$knormal:1|)) (> |$alpha-2:x| 0)) (not (= 0 |$knormal:1|)) (|f$unknown:5| |$alpha-2:x|) )
...
(assert
  (forall ( (|$V-reftype:16| Int) (|$alpha-2:x| Int) (|$knormal:1| Int) )
    (=>
      ( and (= (not (= 0 |$knormal:1|)) (> |$alpha-2:x| 0)) (= |$V-reftype:16| 1) (not (not (= 0 |$knormal:1|))) (|f$unknown:5| |$alpha-2:x|) )
