...
(assert
  (forall ( (|$knormal:1| Bool) (|$V-reftype:1| Int) (|$alpha-2:x| Int) (|$knormal:11| Int) )
    (=>
      ( and (= |$knormal:11| (- 4)) (= |$knormal:1| (< |$alpha-2:x| (- 3))) |$knormal:1| (|f$unknown:3| |$alpha-2:x|) (|f$unknown:1| |$V-reftype:1|) )
...
(assert
  (forall ( (|$knormal:11| Int) (|$alpha-2:x| Int) (|$V-reftype:3| Int) (|$alpha-1:g| Int) (|$knormal:1| Bool) )
    (=>
      ( and (= |$knormal:11| (- 4)) (= |$knormal:1| (< |$alpha-2:x| (- 3))) |$knormal:1| (|f$unknown:3| |$alpha-2:x|) (|f$unknown:2| |$V-reftype:3| |$alpha-1:g|) (|f$unknown:1| |$alpha-1:g|) )
